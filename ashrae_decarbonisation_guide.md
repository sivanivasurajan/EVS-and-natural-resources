...
Description:
A sidebar callout showing the cover of the ASHRAE Position Document on Building Decarbonization, approved by the ASHRAE Board of Directors June 26, 2022, expires June 26, 2025. The document is described as a product of ASHRAE, a global professional society of over 55,000 members.

Key Elements:
- Document title → "ASHRAE Position Document on Building Decarbonization"
- Approval date → June 26, 2022; Expiry → June 26, 2025
- Summary text → This position document emphasizes the necessity of decarbonization, addresses key carbon-reduction principles and decarbonization strategies, and poses challenges that need to be addressed (ASHRAE 2022h). As society faces the challenge of mitigating climate change, ASHRAE's position is that the decarbonization of buildings and their systems must be based on a holistic analysis that includes healthy, safe, and comfortable environments; energy efficiency; environmental impacts; sustainability; operational security; and economics.]

### 1.1.1 Why Decarbonization?

In 2020, existing buildings were responsible for nearly 40% of energy-related greenhouse gas (GHG) emissions, quantified as carbon dioxide equivalent (CO2-eq). In *ASHRAE Position Document on Building Decarbonization*, ASHRAE established that the global built environment must halve its 2015 GHG emissions levels by 2030. It lists three main pillars of this plan:
...
Description:
A stacked/grouped bar chart showing energy-related CO2 emissions by sector in 2020, with the building sector broken down into sub-categories. The chart illustrates that buildings account for 37% of all-sector emissions, with a further breakdown of the building sector on the right side of the figure.

Data Representation:
- Buildings: 37% of All Sectors
- Other Construction Industry: 10% of All Sectors
- Other: 6% of All Sectors
- Other Industry: 23% of All Sectors
- Transportation: 23% of All Sectors
- Residential (Indirect): 30% — part of the 46% residential share of Building Sector
- Residential (Direct): 16% — part of the 46% residential share of Building Sector
- Non-Residential (Indirect): 19% — part of the 27% non-residential share of Building Sector
- Non-Residential (Direct): 8% — part of the 27% non-residential share of Building Sector
- Building Construction (Embodied): 27% — part of the 27% building construction share of Building Sector

- Metric: Energy-related CO2 emissions
- Chart Type: Grouped/Stacked Bar
- Units: Percentage of total emissions

Chart Generation Hint:
- X-axis: Sectors (All Sectors on left, Building Sector breakdown on right)
- Y-axis: Percentage share of total energy-related CO2 emissions
- Series/Groups: All Sectors vs. Building Sector sub-categories; percentage labels shown at 46%, 37%, 27%
- Key annotations: "Buildings, 37%" callout on left panel; sector labels and percentages on right panel

Structured Data (Machine Readable):
{
  "chart_type": "bar",
  "metric": "Energy-related CO2 emissions in 2020",
  "units": "percentage",
  "data": {
    "Buildings": 37,
...
[Figure: ASHRAE Public Policy Information Brief on Building Electrification
Type: Image

Description:
A sidebar callout showing the cover and key content of the ASHRAE Public Policy Information Brief (PPIB) on Building Electrification, published by the ASHRAE Government Affairs Office, 1255 23rd Street NW, Suite 825, Washington, DC 20037.

Key Elements:
- Document title → "ASHRAE Public Policy Information Brief on Building Electrification"
- The Issue summary → Building electrification is often viewed as an essential strategy for building decarbonization, but electrification, in and of itself, does not necessarily guarantee decarbonization. Building electrification refers to transitioning all or portions of building systems to electricity instead of on-site fossil fuel-based, non-electric energy. Space and water heating, some chilled water generation, snow melt, cooking, laundry, and emergency power backup commonly use on-site fossil fuel-based energy.
- Electrification contributes to decarbonization when: (1) the electricity comes from low- or zero-carbon energy sources such as solar, wind, tidal/wave, hydro, and nuclear; or (2) when the efficiency of the new electric equipment results in overall GHG emissions reductions compared to on-site combustion.
- Grid capacity note → The growth of building (and transportation) electrification could require a significant increase in electrical grid capacity, emphasizing the need for energy efficiency, energy storage, grid interactive building design, and alignment of consumption with carbon-free generation (i.e., demand flexibility) to minimize the increase in peak demand.
- Air quality note → Building electrification can present embodied carbon, capital and operating cost, and retrofit challenges; it also provides an opportunity to improve air quality, especially in densely populated areas, by reducing particulate pollution and ground-level ozone from fossil fuel combustion.
- ASHRAE's Role → ASHRAE stands at the forefront in supplying standards, guidance, and education for the design, manufacturing, installation, and operation of building systems. ASHRAE's relevant consensus-based standards include: Standard 90.1 (Energy Standard for Buildings Except Low-Rise Residential Buildings), Standard 90.2 (Energy-Efficient Design of Low-Rise Residential Buildings), Standard 100 (Energy Efficiency in Existing Buildings — being updated as the Energy and Emissions Building Performance Standard), Standard 105 (Standard Methods for Determining, Expressing and Comparing Building Energy Performance and Greenhouse Gas Emissions), Standard 211 (Standard for Commercial Building Energy Audits).
- ASHRAE supports the global need to reduce emissions from buildings, including through beneficial electrification. This public policy information brief (PPIB) outlines the issues and considerations for policy makers regarding building electrification (ASHRAE 2023d).]
...
Description:
A horizontal timeline diagram illustrating the whole-life carbon stages of a building, organized from left to right across the building lifecycle. The diagram is divided into major phases: Embodied (Product Stage and Construction Stage), Operational, Use Stage, End of Life Stage, and Circular Economy (Beyond the Building Life Cycle Stage). The diagram is based on CEN (2011) and credited to P2S Inc.

Key Elements:
- A1: Raw material supply → first step in Product Stage (A1–A3), part of Embodied carbon
- A2: Transport to factory → second step in Product Stage, part of Embodied carbon
- A3: Manufacturing → third step in Product Stage, part of Embodied carbon
- A4: Transport to site → first step in Construction Stage (A4–A5), part of Embodied carbon
- A5: Construction and installation process → second step in Construction Stage, part of Embodied carbon
- B1: Use → first step in Use Stage (B1–B7)
- B2: Maintenance → second step in Use Stage
- B3: Repair → third step in Use Stage
- B4: Replacement → fourth step in Use Stage
- B5: Refurbishment → fifth step in Use Stage
- B6: Operational energy use → shown as spanning bar under Use Stage, part of Operational carbon
- B7: Operational water use → shown as spanning bar under Use Stage, part of Operational carbon
- C1: Deconstruction/demolition → first step in End of Life Stage (C1–C4)
- C2: Transport to waste processing/disposal → second step in End of Life Stage
- C3: Waste processing → third step in End of Life Stage
- C4: Disposal of waste → fourth step in End of Life Stage
- D (Beyond the Building Life Cycle Stage) → Circular Economy: Reuse-Recovery-Recycling-Potential; Benefits and Loads

Image credit: P2S Inc., figure based on CEN (2011)]
...
There are many ways to decarbonize buildings, from passive envelope retrofits to implementing demand response controls. These different decarbonization approaches fit into six strategies that contribute to emissions reduction in various ways. Strategies that are appropriate for a given existing building depend on that building's specific characteristics. Chapter 3 offers a pathway to identify energy-efficiency measures (EEMs) and emission-reduction measures (ERMs) that employ the strategies summarized here.

[Figure: Decarbonization Strategies
Type: Descriptive Diagram

Description:
A circular/radial diagram showing six decarbonization strategies arranged around a central implied building system. Each strategy is shown as a labeled node with explanatory text describing its role in decarbonization. The diagram is organized so that related strategies are positioned adjacent to each other. Image credit: NORESCO.

Key Elements:
- Embodied Carbon → Specifying low GWP materials and sourcing local is becoming important as the industry considers whole life carbon instead of only operational. Environmental Product Declarations (EPDs) can be used to review GWP for common materials.
- Energy Efficiency → Replace equipment, systems and controls to increase efficiency and reduce peak loads. Peak load reduction results in smaller equipment footprints, sizes and cost. Strategies such as thermal energy storage, scheduling, heat recovery, passive design, etc. can reduce peak loads.
- Electrification → Electrifying building systems replaces fossil-fuel-burning equipment with electric. Utilizing heat pump space and water heaters, thermal networks, and electric appliances reduces emissions as electric grids decarbonize.
- Low GWP Fuels/Refrigerants → HFCs, the most popular refrigerants, have a high GWP and therefore careful consideration should be given to equipment specification and resulting refrigerant selection.
- Renewables & Storage → Transitioning to fuel choices such as solar, wind, water, geothermal, bioenergy and nuclear promotes cleaner energy production and better air quality. Considering distributed generation with storage allows energy needs to be met when demand and generation profiles may not align.
- Grid Interactivity → Employing demand responsive technologies increases grid stability contributing to resilience and recovery. It may soon also result in significant utility bill savings as energy pricing moves towards time-of-use.]
...
Description:
A sidebar callout showing the cover of the ASHRAE companion guide titled "Building Performance Standards: A Technical Resource Guide," co-published by ASHRAE and the U.S. Department of Energy.

Key Elements:
- Document title → "Building Performance Standards: A Technical Resource Guide"
- Publishers → ASHRAE and U.S. Department of Energy
- Purpose → This guide is intended to provide a technical basis and resources to policy makers, building owners, facility managers, design professionals, and ASHRAE members when developing and implementing building performance standards (BPS) (ASHRAE 2023g).
...
[Figure: Business Case for Decarbonization — Benefits Overview
Type: Descriptive Diagram

Description:
A quadrant-style diagram presenting four categories of benefits that drive building decarbonization decisions, arranged around a central implicit subject. Each quadrant contains bullet points listing specific benefits within that category.
...
[Table: Building Size Categories
Type: Table

Data:
| Category | Size (Imperial) | Size (Metric) |
|---|---|---|
| Small Commercial | ≤ 10,000 ft² | ≤ 929 m² |
| Medium Commercial | > 10,000 ft² and ≤ 50,000 ft² | > 929 m² and ≤ 4645 m² |
| Large Commercial | > 50,000 ft² | > 4645 m² |
| Multifamily | — | — |
| Hotel/Lodging | — | — |

Notes: These five building categories are used throughout the guide to group buildings with similar system considerations and decarbonization approaches.]
...
[Table: Table 2.1 Case Study Specifications
Type: Table

Data:
| Case Study Number and Name | Building Type and Location | Highlights | Sections |
|---|---|---|---|
| 1 — University of California, Santa Cruz — Phasing Approach | Large Commercial; Santa Cruz, CA | Phasing approach to decarbonization of portfolio of buildings; Address immediate needs with high-efficiency boilers or local heat pumps; Modular, centralized "decarbonization stations" of ASHPs, TES, and electrical infrastructure piped to nearby buildings | 3.2.1, 3.2.2, 3.4.3 |
| 2 — 345 Hudson, New York | Large Commercial; New York City, NY | Comprehensive data strategy by connecting all the current equipment on a common platform; Floor-by-floor replacement of packaged terminal units by WSHP and DOAS phased for tenant turnover; WSHP loop with minimum 85% heat recovery; ASHP connected to condenser water loop as part of a masterplan to phase out boiler; TES water storage tank and connection to adjacent 555 Greenwich for thermal energy transfer given the varying orientation/occupancy of each building; Exploring WSHP for DHW production | 3.2.3, 3.4.8, 3.5.1, 6.1.3.4, 6.1.3.5, 6.3, 7.5.1 |
| 3 — San Diego State University, California | Large Commercial; San Diego, CA | Cogeneration plant evaluated for transition to electrification; Evaluated three options for central plant retrofit: two full electric, one hybrid; Full electric options required upgrading electrical service; Hybrid plant selected to achieve partial electrification within existing electric capacity | 3.3.1.4, 6.1.3 |
| 4 — University of California, Santa Cruz — Cogeneration Plant | Large Commercial; Santa Cruz, CA | Cogeneration plant evaluated for transition to electrification; Reviewed multiple scenarios to supply campus electric needs, reduce campus GHG emissions and realize financial investment in cogeneration plant | 3.4.3.2 |
| 5 — The Heritage | Multifamily; New York City, NY | Reduced heating and cooling loads with EIFS at two buildings. Insulated, prefabricated metal panels with energy-efficient windows at building; Prefabricated panels included electrical infrastructure and punchouts for PTHP upgrades, including capacity for future building electrification; Installation of PTHPs at one building with central ventilation upgrades and centralized controls; Common area dryer electrification at one building; VRF installation in common areas of two buildings; DHW electrification using centralized heat pump water heaters at one building; Submetering apartment electrical use at all three buildings for accurate tenant billing; Tenant engagement and education plan to understand purpose and operation of upgrades | 3.5.2, 3.7, 5.2.1.1, 6.1.1.1, 8.3.2 |
| 6 — Bloedel Conservatory | Medium Commercial; Vancouver, British Columbia, Canada | LED lighting retrofit and roof replacement reduce cooling load; Convert CHW loop to low-temp HHW and CHW switchover loop; Replace chiller/boiler plant with two-pipe AWHP sized for 90% of heating load; Active demand reduction to operate AWHP within existing electrical capacity; AWHP sized for increased cooling load to account for future climate change | 4.2, 6.1.3.2 |
| 7 — StopWaste | Small Commercial; Oakland, CA | Load assessment for increased RTU size and weight; Replaced R-22 VAV RTUs with R-401a VAV Packaged heat pump RTUs | 4.3, 6.1.1.3 |
| 8 — Montreal City Hall | Large Commercial; Montreal, Quebec, Canada | Historic building and site drove many design decisions; Goal of no combustion on-site; Cold climate using purchased steam; Radiant heated ceilings with FCUs; DOAS minimized ductwork; ASHPs located indoors improves winter performance | 4.6, 4.7, 6.1.3.4, 6.1.4 |
| 9 — 47 Seventy Apartments | Multifamily; Taylorsville, UT | Naturally occurring affordable housing retrofit; LED lighting retrofit reduced electric demand; Replaced R22 central air split AC and gas furnaces with split ASHPs with gas furnaces for backup heating; Smart thermostats | 4.9, 6.1.1.2 |
| 10 — McMullen County Courthouse | Small Commercial; Tilden, TX | LED lighting and window retrofits reduce cooling load, allowing for downsizing of existing heat pumps; Recommended insulation upgrades will further reduce cooling loads; Heat recovery and DOAS provide efficient retrofit for reduced load; Parking roof PV will provide clean on-site energy for VRF+DOAS | 5.1.1.2, 5.2.1.3 |
| 11 — Ken Soble Tower | Multifamily; Hamilton, Ontario, Canada | Triple-pane window replacements and envelope upgrades with mineral wool EIFS and liquid applied air barrier reduced heating and cooling loads; Replaced central boiler hydronic baseboards with VRF system with VAV boxes to provide cooling and heating; DOAS with ERVs for ventilation; Condensing boiler for DHW due to electric capacity limitations | 5.2.1.3, 6.1.3 |
| 12 — East Palo Alto Government Center | Medium Commercial; East Palo Alto, CA | LED lighting retrofit with occupancy controls reduced electric demand; Converted pneumatic to DDC with ASHRAE Guideline 36 sequences for HVAC efficiency improvement; VAV terminal units replaced with 2-row oversized coils and rezoned for lower HHW temp; Chiller/boiler plant replaced with rooftop AWHPs (1 with heat recovery) | 5.2.3.5, 6.1.3.2 |
| 13 — Vera Cruz Village | Multifamily; Richgrove, CA | Window replacement, weatherization, and prefabricated insulated roof panels for heating and cooling load reductions; Attic air sealing and insulation or conversion to non-ventilated attics (two buildings); Replaced gas-fired packaged RTUs with ducted heat pumps with ERVs; PTHP (one building) and ducted split heat pump (one building); Distributed HPWHs (three Sanden with 80 gal tanks, the rest hybrid HPWHs); Carport PV with virtual net metering to share between owner and tenants | 6.1.1.3, 7.1.1, 8.3.1 |
| 14 — Skokie County Courthouse | Large Commercial; Cook County, IL | LED lighting retrofit with controls reduced electric demand; Window replacements and weatherization reduced heating/cooling loads; Converted pneumatic to DDC with demand-controlled ventilation and AHU scheduling for HVAC efficiency improvement; Replaced chiller/boiler plant with 200-ton GSHP with backup condensing boilers; GSHP well field sized for majority of cooling load and all but 484 heating hours per year for project economics | 6.1.3 |
| 15 — Stella B. Werner Council Office Building | Large Commercial; Montgomery County, MD | LED lighting retrofit reduced electric demand; Window replacements reduced heating/cooling loads; Mixed HVAC equipment types due to multiple renovations; Replaced HVAC systems (chillers/boilers, RTUs, FCUs, WSHPs) with 300-ton VRF with heat recovery and DOAS; VRF refrigerant lines easier to implement with limited ceiling height | 6.1.3 |
| 16 — Virginia Beach City Public Schools | Large Commercial; City of Virginia Beach | Phased project across multiple schools; Weatherization measures; For each school, installed central GSHP serving WSHP loop; Replaced packaged RTUs with GSHP RTUs | 6.1.3.5 |
| 17 — STAR Transit | Medium Commercial; Terrell, TX | Bus fleet conversion to electric buses; Planned installation of PV; Evaluation demonstrating importance of BESS to align PV production with overnight bus fleet charging | 7.3 |
| 18 — North Oak Development | Large Commercial; Oakfield, Ontario, Canada | District ambient loop for new development; Ground source loop provides space heating/cooling for buildings; Modular design allows future buildings to be connected; DHW loads served by separate boiler | 7.5.4 |
| 19 — Kitsilano Pool | Medium Commercial; Vancouver, British Columbia, Canada | 40% DHW load reduction from low-flow fixtures; After load reduction, central DHW system retrofit with CO2 ASHP and two 250-gallon storage tanks | 8.2.1 |

Notes: Case studies are numbered 1–19 and categorized by building type (Small Commercial ≤ 10,000 ft², Medium Commercial > 10,000 ft² and ≤ 50,000 ft², Large Commercial > 50,000 ft², Multifamily, Hotel/Lodging). Each case study is cross-referenced to relevant guide sections.]
...
Description:
A winding road/path diagram illustrating the sequential and iterative steps to achieving existing building decarbonization, showing five major phases arranged along the path from top to bottom, with each phase containing sub-steps. Image credit: NORESCO.

Process Steps:
1. Establish Framework → Set Goals & Baseline; Define Timeline; Define Scope; Engage Stakeholders
...
Flow Logic:
- Establish Framework → Perform Assessment → Prioritize Measures → Draft Decarbonization Plan → Implement Decarbonization Plan → Track and Report Performance
- An "Ongoing Assessment" arrow runs along the bottom of the entire diagram, indicating that assessment is continuous throughout all phases.
...
Description:
A sidebar callout showing the cover of the ASHRAE companion guide *Building Performance Standards: A Technical Resource Guide*, co-published by ASHRAE and the U.S. Department of Energy.
...
Description:
A cross-section illustration of a multi-story commercial/residential building showing the key systems that are typically involved in building decarbonization projects. Each system is labelled with an arrow pointing to its location in the building. Image credit: NYSERDA (2022).

Key Elements:
- Community Wind Turbines → off-site renewable energy source shown adjacent to building
- Onsite Renewables & Storage → rooftop PV panels and battery storage
- Efficient Heat Pump HVAC → mechanical HVAC system using heat pump technology
- High Performance Envelope → insulated walls and roof assembly
- High Performance Windows → energy-efficient glazing systems
- Building Controls → automation and control systems shown throughout building
- Efficient Electric Appliances and Lighting → interior plug loads and lighting systems
- Efficient Electric Water Heater → domestic hot water system at building base

Notes: Other systems such as refrigeration, thermal energy storage (TES), and ventilation heat recovery are not illustrated but should be considered when applicable.]
...
Notes: Source: Lawrence Berkeley National Laboratory (DOE 2023c)]
...
Notes: Bolded items are unique to a decarbonization assessment.]
...
- GHG emissions intensity (lbCO2e/ft²/yr [kgCO2e/m²/yr])
...
[Table: Table 3.3 Grid Emission Factor Databases
Type: Table
...
| Electricity Maps (Other International) | An open-source tool showing carbon intensity (gCO2eq/kWh) of electricity consumed throughout the world (Electricity Maps n.d.). |
| Gridwatch Web App (Other International) | Includes live grid emissions for Ontario, Canada (Gridwatch n.d.). |
| Canadian Government Emission Factors (Other International) | The Canadian government publishes Canadian emission factors by Province/Territory (Government of Canada n.d.). |

Notes: These databases can be used to obtain grid emission factors for GHG emissions calculations in decarbonization assessments.]

GHG emissions end-use balance (required for Level 2 decarbonization assessments) complements the existing energy end-use balance. The estimated emissions for each end use is calculated by multiplying the estimated energy for each end use by the corresponding GHG emission factors used to determine annual pre-retrofit GHG emissions.

[Figure: Example End-Use Breakdown by Energy and GHG Emissions
Type: Chart

Description:
A donut/concentric circle chart showing the end-use breakdown for a building, with the inner circle representing the energy use breakdown and the outer circle representing the GHG emissions breakdown for the same building. The chart illustrates the difference in prioritization between a typical energy audit and a GHG-focused assessment.

Data Representation:
- Inner circle (Energy): Heating, Cooling, Lighting, Fans, Pumps, Plug Loads, Elevators, Hot Water, Heat Rejection
- Outer circle (GHG Emissions): same end uses but with different proportional weighting, with Heating and Hot Water showing higher GHG share relative to their energy share

- Metric: Building energy end uses and corresponding GHG emissions by end use
- Chart Type: Donut (concentric circles)
- Units: Percentage share of total energy (inner) and total GHG emissions (outer)

Chart Generation Hint:
- Outer ring: GHG emissions proportions by end use
- Inner ring: Energy use proportions by end use
- Key insight: Compared to a typical energy audit (which would prioritize heating, cooling, lights, and fans), the end-use balance assessment by GHG emissions indicates that efficient heating and DHW have the potential to achieve the most GHG reduction.

Structured Data (Machine Readable):
{
  "chart_type": "donut",
  "metric": "End-use breakdown by energy and GHG emissions",
  "units": "percentage",
  "data": {
    "categories": ["Heating", "Cooling", "Lighting", "Fans", "Pumps", "Plug Loads", "Elevators", "Hot Water", "Heat Rejection"],
    "note": "Exact percentage values not labelled in original figure; relative proportions visible only"
  }
}]
...
Description:
A two-dimensional heat map of annual electricity demand for a building, with time of day on the vertical axis (0–24 hours), day of year on the horizontal axis (1–365 days), and colour intensity representing electricity demand level. The chart is titled "Yearly Profile" and shows seasonal and time-of-day patterns in building energy use. Image credit: SmithGroup.

Data Representation:
- X-axis: Day of Time (1–365, representing days of the year)
- Y-axis: Hour of day (0–24)
- Color scale: Representing electricity demand in kW, ranging from approximately −20 kW (cool/blue) to 50 kW (warm/yellow-green)
- Key visible patterns: Higher demand during daytime hours; seasonal variation between summer and winter

- Metric: Electricity demand (kW) by hour of day and day of year
- Chart Type: Heat Map
- Units: kW
...
- Y-axis: Hour of day (0–24)
- Color scale: kW demand, ranging from approximately −20 kW to 50 kW
- Key annotations: "Yearly Profile" as chart title; kW scale shown on right side
...
Structured Data (Machine Readable):
{
  ...
  "units": "kW",
  "data": {
    "x_axis": "Day of year (1-365)",
    "y_axis": "Hour of day (0-24)",
    "color_range": "-20 to 50 kW",
    "note": "Individual hourly values not recoverable from figure"
  }
}

Image credit: SmithGroup]

[Figure: Example Overlay of Hourly Load Profile, Marginal Carbon Rates, and Peak TOU Energy Costs
Type: Chart

Description:
A line chart showing average hourly building energy demand (net building demand with PV) overlaid with marginal carbon rate bands and high carbon/cost hour highlights for a prototypical ASHRAE 90.1-2004 compliant Medium Office building with PV in Washington State. The chart covers a January day (hours 0–22) and shows two key patterns: dips in demand during mid-day (when PV production is highest and marginal carbon is lower) and peaks during morning warm-up and evening periods (when marginal carbon and costs are higher).

Data Representation:
- Net building demand (with PV): line showing hourly building electricity demand net of PV generation
- Marginal carbon: shaded band indicating periods of higher marginal carbon emissions on the grid
- High carbon and cost hours: shaded band indicating peak TOU pricing and high carbon periods

- Metric: Average hourly building demand (kW) vs. grid emission factors and TOU energy costs
- Chart Type: Line (with shaded zones)
- Units: kW for demand; qualitative for carbon and cost bands

Chart Generation Hint:
- X-axis: Hour of day (0–22, January)
- Y-axis: Building demand (kW)
- Series: Net building demand (with PV) as line; Marginal carbon as shaded band; High carbon and cost hours as shaded band
- Key annotations: Legend showing three series; x-axis label "Hour →"; chart title "Average hourly building demand vs. grid emission factors — ASHRAE 90.1-2004 compliant Medium Office prototype with PV in Washington"

Structured Data (Machine Readable):
{
  "chart_type": "line",
  "metric": "Average hourly building demand vs. grid emission factors",
  "units": "kW",
  "data": {
    "note": "Individual hourly kW values not recoverable from figure",
    "series": ["Net building demand (with PV)", "Marginal carbon band", "High carbon and cost hours band"],
    "x_axis": "Hour of day (January, 0-22)"
  }
}

Image credit: ASHRAE (2023d)]
...
Description:
A sidebar callout showing the cover of the ASHRAE guide titled *Grid-Interactive Buildings for Decarbonization: Design and Operation Resource Guide* (ASHRAE 2023h).

Key Elements:
- Document title → "Grid-Interactive Buildings for Decarbonization: Design and Operation Resource Guide"
- Publisher → ASHRAE (2023h)
- Audience → Building operators, designers, owners, consultants, and other building stakeholders
- Purpose → Includes techniques and practices to enable buildings to maximize the benefits from the grid while minimizing the carbon impacts of the grid and building. Builds on ASHRAE's existing Smart Grid Application Guide by providing specific design and operational parameters for building projects that allow the audience to maximize carbon reduction in their interaction with the grid.
- Primary goal → Decarbonization; provides guidance on controls as they shift toward more real-time, automated interaction with the grid.]
...
Description:
A stacked bar chart titled "Laboratory Measured Loads" showing annual hourly heating and cooling loads for a building, with simultaneous heating and cooling (thermal overlap) periods highlighted separately. The vertical axis shows load in kBtu/hr ranging from approximately −8,000 to 22,000. Cooling loads are shown in blue (above zero), heating loads in red (below zero), simultaneous heating in a separate colour, and simultaneous cooling in a fourth colour. Image credit: SmithGroup.

Data Representation:
- Cooling: Positive values (kBtu/hr), shown in blue
- Heating: Negative values (kBtu/hr), shown in red
- Simultaneous Heating: Overlap period load, shown separately
- Simultaneous Cooling: Overlap period load, shown separately

- Metric: Hourly heating and cooling loads (kBtu/hr)
- Chart Type: Stacked Bar
- Units: kBtu/hr

Chart Generation Hint:
- X-axis: Time (annual hourly data, approximately 8,760 data points)
- Y-axis: Load (kBtu/hr), range approximately −8,000 to 22,000
- Series: Cooling (blue), Heating (red), Simultaneous Heating, Simultaneous Cooling
- Key annotations: Legend identifying four series; title "Laboratory Measured Loads"

Structured Data (Machine Readable):
{
  "chart_type": "bar",
  "metric": "Annual hourly heating and cooling loads with thermal overlap",
  "units": "kBtu/hr",
  "data": {
    "series": ["Cooling", "Heating", "Simultaneous Heating", "Simultaneous Cooling"],
    "y_range": "-8000 to 22000",
    "note": "Individual hourly values not recoverable from figure"
  }
}
...
[Figure: PNNL Energy Charting and Metrics (ECAM) Tool
Type: Image

Description:
A sidebar callout describing the PNNL Energy Charting and Metrics (ECAM) Tool.

Key Elements:
- Tool name → Energy Charting and Metrics (ECAM) Tool
- Developer → Pacific Northwest National Laboratory (PNNL)
- Platform → Add-on for Microsoft Excel®
- Purpose → Facilitate the analysis of building and system energy data. Can be used to create various load profiles or scatter charts as well as normalizing data and creating metrics based on consumption or equipment (PNNL n.d.).
- Capabilities → Can create schedules and day-type information to time series data and filter data from months, years, days, day-type, day of week, day of month, occupancy, or temperature-binned weather data.]
...
[Figure: Decarbonizing Building Thermal Systems: A Guide for Heat Pump Systems and Beyond
Type: Image

Description:
A sidebar callout showing the cover of the NREL/ASHRAE guide titled *Decarbonizing Building Thermal Systems: A Guide for Heat Pump Systems and Beyond* (Houssainy et al. 2024), co-published by NREL and ASHRAE.

Key Elements:
- Document title → "Decarbonizing Building Thermal Systems: A How-to Guide for Heat Pump Systems and Beyond"
- Authors → Houssainy et al. 2024
- Publishers → NREL and ASHRAE (Better Buildings initiative)
- Audience → Design engineers and building operators
- Purpose → Focuses on how heat pumps should be applied and how they should be operated in commercial and multifamily buildings to support decarbonization (Houssainy et al. 2024). Provides guidance to design engineers on various heat-pump-specific design elements, including application and sizing in different climate zones, system configuration and refrigerants, electrical requirements, and control and operation strategies for space and hot-water applications.
- Key feature → Includes an in-depth discussion about steps for evaluating electrical capacity for the implementation of electrification technologies.]
...
[Figure: Whole-Life Carbon Guide for Building Systems
Type: Image

Description:
A sidebar callout showing the cover of the forthcoming ASHRAE guide titled *Whole-Life Carbon Guide for Building Systems* (ASHRAE Forthcoming).

Key Elements:
- Document title → "Whole-Life Carbon Guide for Building Systems"
- Publisher → ASHRAE (Forthcoming)
- Audience → Design engineers and ASHRAE members
- Purpose → Provides design engineers strategies to minimize the whole-life carbon emissions from building mechanical, electrical, and plumbing (MEP) systems. MEP systems are major contributors to the operational energy consumption and whole-life carbon emissions of buildings.
- Key data → Recent studies have shown that the embodied emissions from MEP systems can be between 15% and 49% of the total building embodied emissions and even higher if photovoltaic (PV) systems are included on the building.
- Scope → To minimize the whole-life carbon emissions of MEP systems, trade-offs between the embodied carbon and the operational carbon emissions—and among MEP, architectural, and structural systems emissions—should be considered. Provides definitions, concepts, and comprehensive guidance needed to calculate, interpret, and integrate life-cycle data from multiple sources to design MEP systems for low whole-life carbon emissions.]

##### 3.3.1.6.1 Refrigerant Considerations

GHG emissions associated with refrigerant leakage should be included in the life-cycle emissions calculations for measures. Refrigerants used in HVAC systems have a significant impact on the environment. Some refrigerants, such as hydrofluorocarbons (HFCs), have high global warming potential (GWP) values, meaning that they have a greater potential to contribute to global warming compared to carbon dioxide. In recent years, efforts have been made to phase out the use of high-GWP refrigerants and replace them with lower-GWP alternatives, such as hydrofluoroolefins (HFOs), or natural refrigerants, such as ammonia or carbon dioxide. When considering building decarbonization, it is important to estimate the refrigerant leakage GHG emissions and to select HVAC systems that use low-GWP refrigerants or other options that minimize refrigerant use. For example, when considering a building retrofit for which both air-air heat pumps and a VRF system are options, the impact of potential refrigerant leaks and the amount of total refrigerant used in each system should be evaluated as part of the building's carbon emissions. This can involve retrofitting existing systems, upgrading to more energy-efficient systems, or even redesigning buildings to optimize passive strategies and minimize the use of HVAC systems.

[Figure: EPA Fact Sheet: Transitioning to Low-GWP Alternatives in Residential and Commercial Air Conditioning
Type: Image

Description:
A sidebar callout showing the EPA Fact Sheet titled "Transitioning to Low-GWP Alternatives in Residential and Commercial Air Conditioning and Chillers" (EPA 2016).

Key Elements:
- Document title → "Transitioning to Low-GWP Alternatives in Residential and Commercial Air Conditioning and Chillers"
- Publisher → U.S. EPA (2016)
- Purpose → Provides current information on low global warming potential (GWP) alternative refrigerants to high-GWP hydrofluorocarbons (HFCs) for use in residential and commercial air conditioning (AC) equipment, including chillers.
- Key data → HFCs are powerful greenhouse gases (GHGs) with GWPs hundreds to thousands of times more potent per pound than carbon dioxide (CO2); however, more low-GWP alternatives are becoming available.
- Global HFC Emissions data shown in figure (2020 by sector): AC = 28%, MVAC = 13%, Commercial Ref = 26%, Other Ref = 12%, Aerosols/Solvents/Foams/Fire Ext. = 21%; Total Global HFC Emissions = 1,084 MMT CO2 Eq.; Global HFC Emissions in AC = 306 MMT CO2 Eq.
...
| Electrification Impact Calculator (ORNL n.d.) | Estimate potential cost and CO2 emissions savings resulting from changing from fuel-based equipment to electrical equipment. |
...
Notes: Additional tools for calculating emissions are also referenced in ASHRAE's forthcoming Whole-Life Carbon Guide for Building Systems.]
...
Description:
A sidebar callout showing the cover of the U.S. Department of Energy guide titled *Framework for Greenhouse Gas Emissions Reduction Planning: Building Portfolios* (DOE 2023c), published under the Better Climate Challenge and U.S. Department of Energy branding.

Key Elements:
- Document title → "Framework for Greenhouse Gas Emissions Reduction Planning: Building Portfolios"
- Publisher → U.S. Department of Energy (DOE 2023c)
- Purpose → Provides guidance for reducing Scope 1 and Scope 2 GHG emissions for building portfolios and vehicle fleets (DOE 2023c). The framework includes a five-step process for developing an actionable plan for building owners and organizations, from establishing the building inventory to finalizing implementation scenarios, funding, phasing, etc.]
...
|---|---|
| GHG emissions intensity (lb CO2e/ft²) | Benchmark GHG intensity (GHGI) between similar building types that are different sizes by normalizing across square footage. This information is used to determine which buildings within the same building type have the highest GHG intensity. |
...
Notes: Source: Lawrence Berkeley National Laboratory (DOE 2023c). CO2e/ft² is carbon dioxide equivalent per square foot; kBtu/ft² is thousands of British thermal units per square foot.]
...
Description:
A stair-step/ramp diagram showing a prioritized framework for building decarbonization assessment, with numbered steps (0 through 9) arranged in ascending order from left to right. The horizontal axis spans from "Foundational Data" through "Building Upgrades," "Optimize Energy Performance," and "Evaluate Resources." An "Ongoing Assessment" arrow runs along the bottom. Image credit: NORESCO.

Key Elements:
- Step 0: Collect and Analyze Data → Foundational data collection baseline
- Step 1: Reduce Electrical, Heating, and Cooling Loads → Load reduction measures
- Step 2: (unlabeled in figure) → Transition step
- Step 3: Maximize Energy Efficiency → Efficiency upgrades
- Step 4: (unlabeled in figure) → Transition step
- Step 5: Electrify Space Conditioning and Water Heating Systems → Electrification measures
- Step 6: (unlabeled in figure) → Transition step
- Step 7: Optimize Building Automation Systems and Grid Interactivity → Controls and grid integration
- Step 8: Assess Distributed Generation and Clean Power Production → On-site clean power
- Step 9: Utilize Energy Storage; Integrate Grid Interactivity and/or Microgrids; Consider Embodied Carbon; Evaluate Financial Considerations → Advanced strategies and financial evaluation]
...
Notes: This table cross-references the building systems addressed throughout this guide to their respective chapters and sections.]

### 3.4.1 Reducing Heating and Cooling Loads and Rightsizing Equipment

**Building System cross-reference:** Building Envelope → Section 5.2.1
...
[Figure: Annual Heating Load Duration Curve — Load Distribution
Type: Chart

Description:
A combined bar and line chart (Figure 3.8) showing the distribution of annual heating energy consumption as a function of percent of design load for a 60-year-old building with 125,000 ft² (11,600 m²) in a mild climate. The chart demonstrates how most annual heating energy occurs at low load conditions. The y-axes show Cumulative Annual Percent Therm Consumption (left, 0–100%) and Annual Load within Percent Load Bin (right, 0–4,500). A key annotation states "80% of annual heating energy consumption occurs when the load is 25% or less." Image credit: NORESCO.

Data Representation:
- Annual Therms (bar): Distribution of annual gas consumption by percent design load bin
- Cumulative Annual Percent Consumption (line): Orange S-curve showing cumulative consumption
- Building characteristics annotation: 60-year-old building; 125,000 ft² (11,600 m²); Mild climate; Design 22 Btu/ft² (250 W/m²) peak; **Actual 13 Btu/ft² (148 W/m²) peak**

- Metric: Annual heating energy consumption by percent of design load
- Chart Type: Combined Bar and Line (load duration curve)
- Units: Annual Therms (bars), Cumulative % (line)

Chart Generation Hint:
- X-axis: Percent of Design Load (5% to 100%, in 5% increments)
- Y-axis (left): Cumulative Annual Percent Therm Consumption (0–100%)
- Y-axis (right): Annual Load within Percent Load Bin (0–4,500)
- Key annotation: "80% of annual heating energy consumption occurs when the load is 25% or less"
- Technical specs: Design 22 Btu/ft² (250 W/m²) peak; Actual 13 Btu/ft² (148 W/m²) peak

Structured Data (Machine Readable):
{
  "chart_type": "bar",
  "metric": "Annual heating energy consumption by percent design load",
  "units": "Annual Therms and cumulative percentage",
  "data": {
    "building": "60-year-old, 125,000 ft² (11,600 m²), mild climate",
    "design_peak": "22 Btu/ft² (250 W/m²)",
    "actual_peak": "13 Btu/ft² (148 W/m²)",
    "key_finding": "80% of annual heating energy consumption occurs when load is 25% or less"
  }
}

Image credit: NORESCO]

[Figure: Sample Building Annual Heat Load Profile — Serving Peak Loads
Type: Chart

Description:
A combined bar and line chart (Figure 3.9) showing the same building load duration curve as Figure 3.8, but with photographic overlays of air-to-water heat pump modules superimposed on the chart to illustrate which heat pump modules would be needed (green checkmarks) versus not needed (red X marks) for the load distribution. The chart visually demonstrates how rightsizing to the actual peak (13 Btu/ft², 148 W/m²) rather than the design peak (22 Btu/ft², 250 W/m²) eliminates the cost of at least two heat pump modules.

Data Representation:
- Same axes and data as Figure 3.8
- Overlaid heat pump module images: Two modules with green checkmarks (needed) and two modules with red X marks (not needed for most heating hours)

- Metric: Annual heating energy consumption by percent design load with equipment rightsizing illustration
- Chart Type: Combined Bar and Line (load duration curve with overlaid equipment images)
- Units: Annual Therms (bars), Cumulative % (line)

Key insight: Load analysis shows actual peak is 40% lower than the original design. Most of the heating consumption happens at much lower loads. Performing this analysis eliminates the cost of at least two modules.

Image credit: ASHRAE (2024a)]
...
[Figure: Using Future Climate Conditions During Load Estimation
Type: Image

Description:
A sidebar callout describing the DOE/National Laboratories research on future and extreme weather data files for use in building load calculations.

Key Elements:
- Topic → Using Future Climate Conditions During Load Estimation
- Research program → Collaboration between Argonne, Oak Ridge, and Sandia National Laboratories
- Principal investigator → Dr. Ralph T. Muehleisen (Argonne)
- Issue → The use of weather files based on historical weather patterns may not accurately reflect future climate conditions affecting heating and cooling loads.
- Output → Producing a data set of future weather files (fTMY) to use in load calculations and the development of building codes and standards (DOE 2023n).
...
**Building System cross-references:** Building Lighting Systems → Section 5.1.1; Building Appliances and Plug Loads → Sections 5.1.2–5.1.3; HVAC Energy Efficiency and Optimization → Section 5.2.3; HVAC Energy Recovery and Ventilation → Sections 5.2.3.3–5.2.3.4; Building HVAC Control Sequences → Section 6.2
...
**Building System cross-references:** HVAC Systems → Section 6.1; Building HVAC Control Sequences → Section 6.2; Domestic Hot-Water Systems → Chapter 8
...
Description:
A decision tree flowchart guiding the determination of when to electrify existing building equipment. Starting from the question "What is the existing equipment?" the tree branches based on whether the equipment is Electric or Fossil Fuel, and then through a series of yes/no decision points. Image credit: NORESCO.

Process Steps:
1. What is the existing equipment? → branches to Electric or Fossil Fuel
2. Electric path → Can it be more efficient? → Yes: proceed to efficiency; No: Done
3. Fossil Fuel path → Can the building accommodate new electric equipment? (considers available electrical capacity, available structural capacity, available space [indoor, rooftop, or outdoor]) → Yes: Will retrofit meet loads (e.g., HHW temps)? → No: Pursue electric, heating and cooling load reduction → Dual fuel or hybrid solution? → Yes: proceed; No: Upgrade Electrical and/or Structural Capacity → Yes
4. Equipment near end of life? → Yes: Upgrade in the current Capital Plan? → Yes: Life Cycle Evaluations of Retrofit (Carbon + Cost) → Achieves climate or financial goals → Yes: proceed; Does not achieve climate or financial goals → Other funding available? → Yes: proceed; No: Add to Capital Plan for future retrofit trigger
5. Facing financial penalty (e.g., Building Performance Standard)? → Yes: Upgrade in current Capital Plan; No: Follow Capital Plan Upgrade Schedule

Flow Logic:
- Start Process: "What is the existing equipment?"
- End Process nodes: "Done," "Follow Capital Plan Upgrade Schedule," "Add to Capital Plan for future retrofit trigger"
- Decision nodes: Can it be more efficient? / Can the building accommodate new electric equipment? / Equipment near end of life? / Will retrofit meet loads? / Upgrade in current Capital Plan? / Facing financial penalty? / Dual fuel or hybrid solution? / Other funding available?
- Key: Start Process (white box), Energy Source (light box), Decision (white box), End Process (bold outlined box)

Structured Flow (Machine Readable):
{
  "type": "flow_diagram",
  "steps": ["Identify existing equipment type", "Assess efficiency potential (Electric equipment)", "Assess building accommodation capacity (Fossil fuel)", "Evaluate end of life", "Evaluate building performance standard penalty", "Assess capital plan alignment", "Life cycle evaluation", "Determine funding availability"],
  "decisions": [
    {"condition": "Is equipment electric?", "yes": "Can it be more efficient?", "no": "Can building accommodate new electric equipment?"},
    {"condition": "Can it be more efficient?", "yes": "Improve efficiency", "no": "Done"},
    {"condition": "Can building accommodate new electric equipment?", "yes": "Will retrofit meet loads?", "no": "Pursue load reduction / dual fuel"},
    {"condition": "Equipment near end of life?", "yes": "Upgrade in current capital plan?", "no": "Facing financial penalty?"},
    {"condition": "Facing financial penalty?", "yes": "Follow Capital Plan Upgrade Schedule", "no": "Follow Capital Plan Upgrade Schedule"},
    {"condition": "Achieves climate or financial goals?", "yes": "Proceed with upgrade", "no": "Other funding available?"},
    {"condition": "Other funding available?", "yes": "Proceed with upgrade", "no": "Add to Capital Plan for future retrofit trigger"}
  ]
}
...
**Building System cross-references:** Building HVAC Control Sequences → Section 6.2; Battery Energy Storage Systems → Section 7.2; EV Charging → Section 7.3; Grid-Interactive Systems → Section 7.4; Thermal Energy Storage Systems → Section 7.5
...
Description:
A sidebar callout showing the cover of the ASHRAE guide *Grid-Interactive Buildings for Decarbonization: Design and Operation Resource Guide* (ASHRAE 2023d).

Key Elements:
- Document title → "Grid-Interactive Buildings for Decarbonization: Design and Operation Resource Guide"
- Publisher → ASHRAE (2023d)
- Purpose → This guide for building operators, designers, owners, consultants, and other building stakeholders includes techniques and practices to enable buildings to maximize the benefits from the grid while minimizing the carbon impacts of the grid and building. Builds on ASHRAE's existing Smart Grid Application Guide by providing specific design and operational parameters for building projects that allow the audience to maximize carbon reduction in their interaction with the grid. This guide has decarbonization as the primary goal and provides guidance on controls as they shift toward more real-time, automated interaction with the grid.]

### 3.4.5 Distributed Generation and Clean Power Production

**Building System cross-reference:** Renewable Systems → Section 7.1
...
**Building System cross-references:** Battery Energy Storage Systems → Section 7.2; Thermal Energy Storage Systems → Section 7.5
...
[Figure: Tools and Guidance for Estimating Utility Rates
Type: Image

Description:
A sidebar callout listing tools and guidance documents for estimating utility rates, particularly relevant for energy savings performance contracts (ESPCs).

Key Elements:
- Context → Energy savings performance contracts (ESPCs) have long been a key project-financing mechanism for building energy retrofits. These contracts may extend for decades and must establish utility rates to forecast future project savings as part of measure evaluations.
- Tool 1 → NIST Energy Escalation Rate Calculator — The National Institute of Standards and Technology (NIST) provides an energy escalation rate calculator for estimating future energy rates.
- Tool 2 → The Federal ESPC program: Guidance on Utility Rate Estimations and Weather Normalization in Performance Contracts
- Tool 3 → Recommended vs. Actual Escalation Rates for ESPCs: Is the Guidance Good?]

[Figure: Resilience in the Face of Climate Events
Type: Descriptive Diagram

Description:
A sidebar callout describing climate resilience for decarbonized buildings, including a reference to the U.S. Climate Resilience Toolkit and its five-step framework.

Key Elements:
- Context → Buildings that are decarbonized today must be resilient to current and future climate change impacts. This may involve upgrading building systems and installing energy storage to withstand extreme weather events such as floods, hurricanes, high winds, heat waves, or other climate-related hazards.
- Role of buildings → Buildings in particular play a key role in resilience initiatives and policy. Keeping buildings habitable through extreme heat or freeze events and through heavy precipitation and extreme wind or smoke can limit displacement and provide community shelter when required.
- Economic role → Commercial building operation directly affects local economies by enabling businesses to stay open or reopen quickly after climate events.
- Synergy note → Many decarbonization retrofits, such as weatherization improvements, structural enhancements, window replacements, and HVAC system upgrades, provide opportunities to improve an existing building's resilience.
- Tool → U.S. Climate Resilience Toolkit: includes a five-step framework to document climate hazards and produce solutions to reduce climate-related risks (U.S. Climate Resilience Toolkit n.d.). More than 50 case studies are offered showing how resilience is being addressed throughout the U.S. and territories. The compilation of digital tools ranging from templates to interactive analyses can help individuals and communities understand and manage their climate-related risks and opportunities.
- Five steps → 1. Understand Exposure; 2. Assess Vulnerability & Risk; 3. Investigate Options; 4. Prioritize & Plan; 5. Take Action]
...
Description:
A sidebar callout showing the cover of the CIBSE/ASHRAE publication *Embodied Carbon in Building Services: A Calculation Methodology for North America* (TM65NA: 2024) (CIBSE 2024).

Key Elements:
- Document title → "Embodied carbon in building services: a calculation methodology for North America" (TM65NA: 2024)
- Publisher → CIBSE and ASHRAE (2024)
- Background → The Chartered Institution of Building Services Engineers (CIBSE) developed and published *Embodied Carbon in Building Services: A Calculation Methodology* (TM65) in 2021. TM65 outlines the need for assessing the embodied carbon of mechanical, electrical, and plumbing (MEP) systems and offers guidance on how to estimate the embodied carbon of MEP products when environmental product declarations (EPDs) are not available.
- Scope → TM65 provides valuable information for the MEP community and beyond; however, many of the method's assumptions are specific to the United Kingdom. This addendum addresses North America (CIBSE 2024).
- Life cycle stages covered → Product, Construction, In Use, End of Life]
...
| Environmental | Operational Carbon—Water Use | Water use of systems, particularly those that affect energy use for DHW systems. |
...
| Maintainability | Compatibility | Compatibility of proposed measures with other building systems and processes |
| Maintainability | Technology Readiness | Availability & maturity of technology and number of manufacturers |
| Resilience | Redundancy and Backup | Levels of redundancy offered by technology |
| Resilience | Resilience | Ability of technology to offer resilience to building |
| Resilience | Climate Adaptation | Ability to adapt to climate change and future weather conditions |

Notes: Adapted with Permission from CSU's Decarbonization Framework (CSU 2023c).]

[Figure: Example Comparison of ERM Packages
Type: Chart

Description:
A grouped bar chart (Figure 3.11) comparing two packages of emissions reduction measures (ERMs) against the building's GHG emissions baseline. The y-axis shows CO2-equivalent emissions as a percentage of baseline emissions (0–100%). Each package is shown as a series of stacked/grouped bars representing the cumulative effect of adding each ERM in sequence. Both packages achieve 50% reductions from baseline.

Data Representation:
- Baseline: 100% of baseline emissions
- Package of Measures Option 1 (ERMs 1, 3, 6, 7): Lighting and HVAC Upgrades, Geothermal Heat Pump Heating
- Package of Measures Option 2 (ERMs 2, 4, 5, 6, 8, 9): Envelope Improvements, Lighting and HVAC Upgrades, Air Source Heat Pump Heating
- Both packages end at approximately 50% reduction from baseline (labeled "50%")

- Metric: CO2-equivalent emissions as percentage of baseline
- Chart Type: Grouped Bar (cumulative emissions reduction)
- Units: % of Baseline Emissions

Chart Generation Hint:
- X-axis: ERM sequence labels (Baseline, ERMs 1/3/6/7 for Option 1, ERMs 2/4/5/6/8/9 for Option 2)
- Y-axis: CO2-equivalent emissions (% of baseline, 0–100%)
- Series: Package of Measures Option 1 (Lighting and HVAC Upgrades, Geothermal Heat Pump Heating); Package of Measures Option 2 (Envelope Improvements, Lighting and HVAC Upgrades, Air Source Heat Pump Heating)
- Key annotations: "50%" labels on both final bars; "Cumulative Emissions Reduction Measures" as x-axis label
...
Structured Data (Machine Readable):
{
  ...
  "data": {
    "Baseline": 100,
    "Package 1 final (ERMs 1,3,6,7 - Lighting upgrades, HVAC upgrades, GSHP)": 50,
    "Package 2 final (ERMs 2,4,5,6,8,9 - Envelope improvements, lighting upgrades, HVAC upgrades, ASHP)": 50
  }
}

Image credit: LBNL (DOE 2023c)]
...
There are numerous drivers behind the economics of existing building decarbonization measures. The easiest, most common way of justifying a measure is by prioritizing the shortest simple payback (SPB) or best return on investment (ROI), especially if the SPB/ROI falls within the time left on a current lease or, for an owner-occupied building, within the owner's financial criteria. Bundling measures with a range of SPBs is another way to justify implementing numerous measures, especially those with longer SPBs that can be harder to justify as stand-alone projects. Other variables to consider with the SPB approach include incentives, grants, tax credits, etc., that are available to reduce capital costs. If the project qualifies, usually these are estimated and deducted from the first cost, and then the net SPB is calculated.
...
Notes: These represent common funding mechanisms; availability varies by location and program.]
...
Description:
A horizontal timeline diagram (Figure 3.12) from the 345 Hudson project case study, showing the planned sequence and timing of emissions reduction measures from 2020 to 2030, organized by year along a horizontal axis with labelled milestone events above and below the timeline arrow.

Key Elements:
- 2020 → Data Strategy — Connect Everything; Replace Primary AHU with High Energy Recovery; Deep Retrofit Floors 2,3,7,8 & 9; Move To Ambient Loop (Add ASHP And Dry Coolers); Enable Data And AI Solutions
- 2021 → (transition year)
- 2022 → (transition year)
- 2023 → Connect Thermal Storage — Water Tanks; Connect To 555 GW To Share Energy
- 2024 → (transition year)
- 2025 → (transition year)
- 2026 → Deep Retrofit Floors 10, 11, 13, 16, & 17
- 2027 → (transition year)
- 2028 → Deep Retrofit Floors 4, 5, 6, 12, 14, & 15
- 2029 → (transition year)
- 2030 → Complete Ambient Loop — 100% Electric Building

Image credit: Hudson Square Partnership]
...
Description:
A sidebar callout describing Architecture 2030's Carbon Avoided: Retrofit Estimator (CARE) Tool.

Key Elements:
- Tool name → Carbon Avoided: Retrofit Estimator (CARE) Tool
- Developer → Architecture 2030
- Purpose → Reusing, recycling, and recovering equipment and other building materials can significantly reduce the carbon impact of building renovations. These concepts should be considered and included in the building's decarbonization plan.
- Capability → Architecture 2030's CARE Tool can be used to compare variables of embodied and operating carbon over different timelines for reuse versus replacement.]
...
Description:
A sidebar callout showing the cover of the DOE *Framework for Greenhouse Gas Emissions Reduction Planning: Building Portfolios* guide (DOE 2023c), published under the Better Climate Challenge and U.S. Department of Energy branding.

Key Elements:
- Document title → "Framework for Greenhouse Gas Emissions Reduction Planning: Building Portfolios"
- Publisher → U.S. Department of Energy (DOE 2023c)
- Purpose → Includes additional guidance on developing and evaluating implementation scenarios for building portfolios. The framework reviews how to apply ERM packages to multiple buildings and create short-, medium-, and long-term implementation plans to inform building manager decision-making.]

[Figure: Building Efficiency Targeting Tool for Energy Retrofits (BETTER)
Type: Image

Description:
A sidebar callout describing the DOE Building Efficiency Targeting Tool for Energy Retrofits (BETTER).

Key Elements:
- Tool name → Building Efficiency Targeting Tool for Energy Retrofits (BETTER)
- Developer → U.S. Department of Energy
- Purpose → Software toolkit that enables building operators to quickly and easily identify the most cost-saving energy efficiency measures in buildings and portfolios using readily available building and energy data. With minimal data entry (DOE n.d.-b), BETTER benchmarks a building's or portfolio's energy use against peers; quantifies energy, cost, and greenhouse gas (GHG) reduction potential; and recommends energy efficiency measures (technological and operational) for individual buildings or portfolios, targeting specific energy savings levels.]
...
Description:
A comprehensive benefits and impacts matrix (Figure 3.14) for a multifamily building showing EEMs and ERMs organized by building system category, with columns for benefits (GHG savings rated by stars, Comfort, Health/IAQ, Energy Cost Savings in dollar signs) and impacts (Costs in dollar signs, Lifespan in years, Maintenance level, Tenant/Disruption level, and "When to Implement" showing Now, Mid-Cycle, and Future Refi checkmarks). Image credit: BE-Ex (2023a).

Key Elements:
- Building systems covered: Envelope, HVAC, Domestic hot water, Lighting, Plug loads, Solar PV
- Envelope measures: Roof Insulation, Windows/Doors, Air Sealing & Weatherization, Exterior Wall Insulation
- HVAC measures: Heating System Upgrades, Electrify Heating, Pipe Insulation, Ventilation Upgrades
- Domestic hot water measures: Electrify Hot Water Heating, Plumbing Fixture Upgrades
- Lighting measures: Common Area & Exterior Upgrades, In-Unit Upgrades
- Plug loads measures: Appliance Upgrades, Electrify Cooking, Electrify Laundry
- Solar: Solar PV
- GHG Savings ratings range from 1 star (low) to 5 stars (high)
- Energy Cost Savings range from $ (low) to $$$$ (high)
- Costs range from $ (low) to $$$$$ (high)
- Lifespan values range from 10 to 25 years
- Notes: "Upgrades" denotes improving efficiency of existing system/equipment, while "Electrify" involves installing equipment that utilizes electricity rather than fossil fuels as a power source; items marked with superscript 2 are LL87 Prescriptive Energy Conservation Measure; Solar is required by LL92/94 and HPD's Solar Where Feasible (SWF) Mandate; lifespan estimated following New York State Approach for Estimating Energy Savings from Energy Efficiency Programs Technical Resource Manual v6.1; "Per HPD Guidelines" are items required based on Rehab Classification and HPD Program.

Image credit: BE-Ex (2023a)]
...
Description:
A line chart (Figure 3.13) showing historical greenhouse gas emissions and four projected renovation scenarios for a building portfolio from 2020 to 2040, compared against 50% and 80% reduction targets. The y-axis shows Greenhouse Gas Emissions in Thousand MTCO2e (0–160). Image credit: Lawrence Berkeley National Laboratory (DOE 2023c).

Data Representation:
- Historical Emissions: Solid bar/line showing historical GHG emissions baseline (approximately 140 thousand MTCO2e)
...
- Scenario 3: Moderate Efficiency, Deep Electrification (dotted line)
- Scenario 4: Moderate Efficiency, Moderate Electrification (dotted line)
- 50% Reduction Target: horizontal reference line at approximately 70 thousand MTCO2e
- 80% Reduction Target: horizontal reference line at approximately 28 thousand MTCO2e
...
- Y-axis: Greenhouse Gas Emissions (Thousand MTCO2e, 0–160)
- Series: Historical Emissions; Scenarios 1–4; 50% and 80% Reduction Target lines
- Key annotations: "50% Reduction Target" and "80% Reduction Target" labels; scenario name labels in legend

Structured Data (Machine Readable):
{
  "chart_type": "line",
  "metric": "Portfolio greenhouse gas emissions under different renovation scenarios",
  "units": "Thousand MTCO2e",
  "data": {
    "baseline": "~140 thousand MTCO2e (2020)",
    "50_percent_target": "~70 thousand MTCO2e",
    "80_percent_target": "~28 thousand MTCO2e",
    "scenarios": ["Deep Efficiency + Deep Electrification", "Deep Efficiency + Moderate Electrification", "Moderate Efficiency + Deep Electrification", "Moderate Efficiency + Moderate Electrification"],
    "note": "Individual annual values not recoverable from figure"
  }
}

Image credit: Lawrence Berkeley National Laboratory (DOE 2023c)]
...
Overall emissions reductions can be tracked using the Energy Star Portfolio Manager with imported utility consumption data. More detailed performance tracking and reporting could be conducted in accordance with the measurement and verification (M&V) plan, which should be included as an appendix to the decarbonization plan. The M&V plan should clearly document what parameters should be monitored for each EEM and ERM, how, and at what frequency. The M&V plan should also specify to whom performance reports should be provided and at what frequency—someone will need to own monitoring the progress toward goals.
...
With decarbonization retrofits, there are some logistical performance items to verify beyond the energy use and GHG emissions performance. Verify that new electrical equipment operates effectively without electrical capacity issues (overloading/tripping circuits). Verify that any electrical system controls, such as circuit-sharing devices or load shifting/shedding from grid-interactive software, provide correct responses under design conditions and do not result in electrical capacity issues or increased grid use during higher GHG emissions periods. Verify sufficient heating hot-water temperatures where fossil fuel heating (e.g., boilers) was replaced with heat pumps to ensure that needed supply temperatures are met. Verify that equipment operation does not disturb occupants (e.g., noise levels).
...
[Figure: ASHRAE Guideline 14, Measurement of Energy, Demand, and Water Savings
Type: Image

Description:
A sidebar callout showing the cover of ASHRAE Guideline 14-2023 (Supersedes ASHRAE Guideline 14-2014): *Measurement of Energy, Demand, and Water Savings* (ASHRAE 2023e).

Key Elements:
- Document title → "Measurement of Energy, Demand, and Water Savings" (Guideline 14-2023)
- Publisher → ASHRAE (Approved August 1, 2023)
- ISSN → 1049-894X
- Purpose → Provides guidance for reliably measuring the energy, demand, and water savings achieved in conservation projects (ASHRAE 2023e). The guideline presents a standardized set of energy, demand, and water savings calculation procedures and guidance on minimum acceptable levels of performance for determining savings and using measurements in commercial transactions.
- Intended for → Transactions between energy service companies (ESCOs) and their customers and between ESCOs and utilities, where the utilities have elected to purchase energy savings.
- Includes → Access to RP-1050 and RP-1093 Final Reports and the ASHRAE Inverse Modeling Toolkit and Diversity Factor Toolkit (requires Microsoft Excel).]

### 3.7.3 Operation and Maintenance Procedures

Similar to energy efficiency projects, proper operation and routine maintenance are crucial for decarbonization retrofits. Develop a maintenance plan that includes the level of GHG emissions impact for different equipment and systems. The plan should employ both system-level and equipment-level maintenance plans. Equipment-level maintenance plans will include regular preventative maintenance as recommended by the manufacturer. The system-level maintenance plans focus on cooling/heating source, distribution network, and delivery terminals because of the interactive nature of decarbonization solutions. System-level maintenance plans should incorporate monitoring and evaluating system data to inform maintenance for these interdependent systems because of system-wide effects from single-equipment failure. For VRF systems in particular, maintenance procedures should include regular checks of system refrigerant charge to identify and quickly address refrigerant leaks and limit GHG emissions impacts from leaks.
...
[Figure: Apartment and Office Building Association of Metropolitan Washington Educational Foundation's Operations and Maintenance Best Practices for Energy Management Guide
Type: Image

Description:
A sidebar callout showing the cover of the AOBA guide titled *Operations and Maintenance Best Practices for Energy Management* (AOBA 2023).

Key Elements:
- Document title → "Operations and Maintenance Best Practices for Energy Management"
...
Description:
A horizontal grouped bar chart showing the percentage of total commercial buildings and percentage of total commercial floor space served by each type of heating equipment in 2018, based on EIA CBECS data. Two bars are shown per equipment type — one for percentage of buildings, one for percentage of floor space — with the x-axis ranging from 0% to 50%.

Data Representation:
- Packaged heating units: ~37% of buildings / ~50% of floor space; Average building size: 22,000 ft²
- Furnaces: ~27% of buildings / ~18% of floor space; Average building size: 10,700 ft²
- Individual space heaters: ~20% of buildings / ~17% of floor space; Average building size: 17,000 ft²
- Boilers: ~12% of buildings / ~30% of floor space; Average building size: 41,000 ft²
- Heat pumps: ~10% of buildings / ~22% of floor space; Average building size: 22,400 ft²
- Duct reheat: ~5% of buildings / ~55% of floor space; Average building size: 55,200 ft²
- District heat: ~3% of buildings / ~79% of floor space; Average building size: 79,300 ft²

- Metric: Percentage share of total commercial buildings and total commercial floor space by heating equipment type
- Chart Type: Grouped Bar (horizontal)
- Units: Percentage (%) and average building size (ft²)

Chart Generation Hint:
- X-axis: Percentage of total commercial buildings / percentage of total commercial floor space (0–50%)
- Y-axis: Heating equipment type categories
- Series: Percentage of total commercial buildings (purple/darker bar); percentage of total commercial floor space (grey/lighter bar)
- Key annotations: Average building size (ft²) labels shown at right for each equipment type

Structured Data (Machine Readable):
{
  "chart_type": "bar",
  "metric": "Commercial buildings and floor space by heating equipment type, 2018",
  "units": "percentage and ft²",
  "data": {
    "Packaged heating units": {"buildings_pct": 37, "floor_space_pct": 50, "avg_size_ft2": 22000},
    "Furnaces": {"buildings_pct": 27, "floor_space_pct": 18, "avg_size_ft2": 10700},
    "Individual space heaters": {"buildings_pct": 20, "floor_space_pct": 17, "avg_size_ft2": 17000},
    "Boilers": {"buildings_pct": 12, "floor_space_pct": 30, "avg_size_ft2": 41000},
    "Heat pumps": {"buildings_pct": 10, "floor_space_pct": 22, "avg_size_ft2": 22400},
    "Duct reheat": {"buildings_pct": 5, "floor_space_pct": 55, "avg_size_ft2": 55200},
    "District heat": {"buildings_pct": 3, "floor_space_pct": 79, "avg_size_ft2": 79300}
  }
}

Image credit: EIA (2018)]

## 6.1 HVAC System Retrofits

[Table: Table 6.1 Common HVAC Systems and Decarbonization Retrofit Options
Type: Table
...
| Small Commercial; Medium Commercial; Large Commercial | Packaged rooftop unit (RTU) with furnace | Single zone; Single-duct terminal units with zone reheat; Dual-duct terminal units | **Partial Electrification:** In cold climates, may consider dual-fuel heat pump RTU; **Full Electrification:** Heat pump RTU or Variable refrigerant flow (VRF) system | • Review manufacturer's designed performance for cold climates (temperatures <10°F [–12°C]); may consider using the existing furnace or installing dual-fuel heat pumps for these applications; • Account for unit defrost cycle during heating operation; • Confirm available electrical capacity to support heat pump; • Evaluate GHG emissions from estimated refrigerant leaks for system, particularly for VRF systems; • For RTUs with zone reheat, evaluate sizing of RTU for heating with heat pump vs. zone reheat to optimize: Efficiency, GHG emissions, Energy cost, RTU size for roof space and weight capacity |
| **Central Boiler Retrofits** | | | | |
| Small Commercial; Medium Commercial; Large Commercial | VAV reheat with packaged RTUs or Air-handling unit (AHU) | Single-duct terminal units with zone reheat; Dual-duct distribution | **Partial Electrification:** Packaged rooftop heat pumps or centralized heat pumps paired with condensing boiler for peak heating days, or Heat recovery chiller (optional TES); **Full Electrification:** Air-to-water heat pump to replace boiler (optional TES), or Ground-source heat pump (GSHP), or VRF system; **Dual-duct distribution:** Same as single-duct AHU but may consider retaining AC unit for cold deck and grouping heat pumps to serve hot deck (and cold deck) | **Partial Electrification:** Evaluate sizing of heat pump vs. condensing boiler to optimize: Efficiency, GHG emissions, Energy cost, RTU size for roof space and weight capacity, Electrical capacity; **Full Electrification:** • Perform heating system temperature stress test to determine minimum HHW operating temperature to meet loads; • Confirm available electrical capacity to support heat pump; • For air-to-water heat pumps, review manufacturer's designed performance for cold climates (temperatures <10°F [–12°C]) to determine need for supplemental heating; • Account for unit defrost cycle during heating operation; • Evaluate GHG emissions from estimated refrigerant leaks for system, particularly for VRF systems; • TES used to shift peak load using heat recovery (morning warm-up) can be paired with AWHP and/or heat recovery chillers; • Evaluate HHW reheat or four-pipe systems for heat recovery between zones |
| Medium Commercial; Large Commercial; Multifamily; Hotel/Lodging | Two-pipe or four-pipe fan coil units (FCU) with boiler | Local FCU | **Partial Electrification:** Heat pumps paired with condensing boiler or other high-efficiency boiler for peak heating days or Heat recovery chiller (optional TES); **Full Electrification:** Air-to-water heat pump to replace boiler (optional TES), or GSHP, or VRF system | — |
...
Notes: Table 6.1 covers Gas Furnace Retrofits and Central Boiler Retrofits across small, medium, large commercial, multifamily, and hotel/lodging building types. Retrofit options are categorized as Partial Electrification or Full Electrification.]
...
Description:
A composite photograph showing multiple stages of split-system heat pump installation at Vera Cruz Village Apartments (Building 615), including exterior condenser unit mounting, refrigerant line routing along building walls, and installation of indoor air handler components. Images show various phases of the mechanical installation process.

Key Elements:
- Exterior condenser units → mounted on building exterior walls/ground at multiple locations
- Refrigerant line routing → copper refrigerant lines running along exterior building wall
- Indoor components → air handler installation visible in one of the photos
- Building context → single-story residential apartment building with stucco exterior

Image credit: Rocky Mountain Institute and Self-Help Enterprises]
...
Another option when there are limitations on a split heat pump to meet the full heating load can be to install dual-fuel heat pumps. These allow for supplemental heating, typically natural gas fired, that can meet the heating load when the outdoor temperatures fall below the operating range of the heat pump. A dual-fuel heat pump application may be a good solution when supplemental heating is needed but the existing furnace does not have sufficient EUL remaining to be an acceptable solution.
...
Description:
A schematic diagram illustrating the internal components and airflow/refrigerant flow of a dual-fuel split-system heat pump paired with a gas furnace backup. The diagram shows the indoor air handler assembly and the outdoor heat pump unit, with labeled components and flow paths.

Key Elements:
- Heat Pump Indoor Unit (Primary Heating & Cooling Source) → indoor air handler providing primary heating and cooling
- Gas Furnace (Back-Up Heat Source) → auxiliary gas furnace for supplemental/backup heating when outdoor temperatures fall below heat pump operating range
- Furnace Exhaust → flue exhaust from gas furnace shown exiting at top
- Refrigerant Lines → refrigerant circuit connecting indoor and outdoor units
- Gas Supply → gas line feeding the backup furnace
- Air Handler Blower (Fan) → indoor fan circulating conditioned air
- Air Filter → air filtration at air handler inlet

Image credit: Slipstream (2022)]
...
Description:
A 3D rendering showing a VRF (variable refrigerant flow) system configuration with one outdoor condensing unit connected to multiple indoor terminal units distributed across different zones/rooms of a building. Refrigerant lines branch from the outdoor unit to each indoor unit.

Key Elements:
- Outdoor condensing unit → single outdoor unit providing refrigerant to multiple indoor units
- Indoor terminal units → multiple fan coil/cassette-type indoor units distributed to individual zones
- Refrigerant line branching → refrigerant piping network connecting outdoor unit to each indoor unit
- Multi-zone capability → each indoor unit independently controlled for heating or cooling

Image credit: vwqpwv/Shutterstock.com]

VRF systems use distributed refrigerant lines between the outdoor and indoor units to move heat. These refrigerant lines often require complex field installation and commissioning that may pose challenges, particularly for refrigerant leakage. The refrigerant distribution systems for VRF are frequently fabricated and installed in the field, and the quality of installation can have significant effects on system performance and, most importantly for GHG emissions, on refrigerant leakage rates. For VRF systems with a large amount of field-installed refrigerant piping, ASHRAE Standard 228-2023 provides an annual leakage rate of 10% (ASHRAE 2023b). For large buildings with large VRF systems, the GHG emissions attributed to refrigerant leakage can be significant over the life of the system. These GHG emissions from refrigerant leakage should be accounted for in determining the GHG impacts for the retrofit project when evaluating options. See Section 3.3.1.6.1 in Chapter 3 for a discussion of refrigerant impacts and ASHRAE's *Whole-Life Carbon Guide for Building Systems* for details on calculating the life-cycle carbon for buildings and retrofits. Pre-manufactured flexible line sets reduce installation cost and the number of joints, which reduces leakage potential. There may be aesthetic considerations for exposed refrigerant line sets, but they should be considered in all situations for cost and leakage reasons.
...
Description:
A schematic block diagram illustrating the cascading hydronic heat pump system configuration, divided into an Airside section and a Waterside section. The diagram shows the sequential flow of water from the ambient air-source heat pump (AWHP) through a buffer tank to a water-source heat pump (WSHP) to achieve high hot-water supply temperatures.

Key Elements:
- Airside section → ambient conditions feed into the AWHP
- AWHP (Air-to-Water Heat Pump) → first stage; raises water temperature from ambient to 90–100°F (32.2–37.8°C)
- Buffer Tank Water (90–100°F) → intermediate storage between AWHP and WSHP to stabilize operation
- WSHP (Water-Source Heat Pump) → second stage; boosts hot-water supply temperature to 160–180°F (71.1–82.2°C)
- HHW Supply 160–180°F → final heating hot-water supply delivered to the building heating system
- Waterside section → encompasses Buffer Tank and WSHP
...
Description:
A sidebar callout showing the cover of the ASHRAE publication *Geothermal Heating and Cooling: Design of Ground-Source Heat Pump Systems* (Kavanaugh and Rafferty 2014), identified by ASHRAE Research Project number RP-1674.

Key Elements:
- Document title → "Geothermal Heating and Cooling: Design of Ground-Source Heat Pump Systems"
- Authors → Steve Kavanaugh and Kevin Rafferty
- Publisher → ASHRAE (RP-1674)
- Subtitle → "A Complete Guide to Design of Ground-Coupled, Groundwater, and Surface-Water Systems for Commercial and Institutional Buildings"
- Purpose → Recognized as the primary reference for nonresidential GSHP installations. Essential guide for HVAC design engineers, design-build contractors, GSHP subcontractors, and energy/construction managers; also provides building owners and architects with insights into characteristics of quality engineering firms and the information that should be provided by design firms competing for GSHP projects (Kavanaugh and Rafferty 2014).]
...
The figures below show the DT and hot-water return temperature (HWRT) as a function of the hot-water supply temperature (HWST) for one-row, two-row, and three-row hot-water coils at a given capacity (same entering and leaving air temperatures at the same airflow rate), and the hot-water flow requirements for the same coils and conditions. The figures show that one-row coils struggle to provide enough capacity (for these given conditions) below ~145°F (~62.8°C) water as they max out on flow and minimum DT. As additional rows are added, lower hot-water supply temperatures are viable, often with reasonable DTs and flow rates.
...
Description:
A line chart showing heating hot-water (HHW) delta-T (dT, left y-axis in °F) and hot-water return temperature (HWRT, right y-axis in °F) as a function of hot-water supply temperature (HWST, x-axis in °F) for standard capacity coils in an 8-inch box at 250 CFM reheat, 63°F entering air temperature (EAT), and 90°F leaving air temperature (LAT). Six lines are shown: three solid lines for dT (1-row, 2-row, 3-row) and three dashed lines for HWRT (1-row, 2-row, 3-row).

Data Representation:
- X-axis: HWST (°F), range 115–195°F
- Left Y-axis: HW dT (°F), range 0–120
- Right Y-axis: HWRT (°F), range 80–170
- 1-Row Standard Coil dT → solid orange line; lowest dT values across HWST range; maxes out at ~145°F HWST
- 2-Row Standard Coil dT → solid blue line; moderate dT values
- 3-Row Standard Coil dT → solid green line; highest dT values
- 1-Row Standard Coil HWRT → dashed orange line
- 2-Row Standard Coil HWRT → dashed blue line
- 3-Row Standard Coil HWRT → dashed green line

- Metric: Heating hot-water delta-T and return temperature vs. supply temperature for 1-, 2-, and 3-row standard capacity reheat coils
- Chart Type: Line
- Units: °F for HWST (x-axis), °F for dT (left y-axis), °F for HWRT (right y-axis)

Chart Generation Hint:
- X-axis: HWST (°F) from 115 to 195
- Left Y-axis: HW dT (°F) from 0 to 120
- Right Y-axis: HWRT (°F) from 80 to 170
- Series: 6 lines — solid dT lines and dashed HWRT lines for 1-row, 2-row, and 3-row coils
- Coil conditions: 8" Box, 250 CFM reheat, 63°F EAT, 90°F LAT (standard capacity)
- Key annotation: Chart title "Standard Capacity Coils - 8" Box - 250 CFM reheat - 63°F EAT - 90°F LAT"

Structured Data (Machine Readable):
{
  "chart_type": "line",
  "metric": "HHW temperatures and DT for 1-, 2-, and 3-row coils",
  "units": "°F",
  "conditions": "8-inch box, 250 CFM reheat, 63°F EAT, 90°F LAT",
  "data": {
    "x_axis": "HWST (°F), range 115-195",
    "left_y_axis": "HW dT (°F), range 0-120",
    "right_y_axis": "HWRT (°F), range 80-170",
    "series": ["1-Row Standard Coil dT", "2-Row Standard Coil dT", "3-Row Standard Coil dT",
               "1-Row Standard Coil HWRT", "2-Row Standard Coil HWRT", "3-Row Standard Coil HWRT"],
    "key_finding": "1-row coils struggle to provide sufficient capacity below ~145°F HWST; additional coil rows allow lower HWST with reasonable DTs and flow rates"
  }
}]
...
Description:
A line chart showing heating hot-water (HHW) flow rate (gpm, y-axis) as a function of hot-water supply temperature (HWST, x-axis in °F) for standard capacity coils in an 8-inch box at 250 CFM reheat, 63°F EAT, and 90°F LAT. Three lines are shown for 1-row, 2-row, and 3-row standard capacity coils.

Data Representation:
- X-axis: HWST (°F), range 115–195°F
- Y-axis: Flow (gpm), range 0–5
- 1-Row Standard Coil Flow → solid orange line; dramatically higher flow at low HWST (peaks ~4.5 gpm at ~140°F HWST), drops steeply as HWST increases
- 2-Row Standard Coil Flow → solid blue line; moderate flow; peaks ~1.2 gpm at low HWST
- 3-Row Standard Coil Flow → solid green line; lowest flow requirements across HWST range; approximately 0.5 gpm or less

- Metric: Heating hot-water flow rate vs. supply temperature for 1-, 2-, and 3-row standard capacity reheat coils
- Chart Type: Line
- Units: gpm (y-axis), °F (x-axis)

Chart Generation Hint:
- X-axis: HWST (°F) from 115 to 195
- Y-axis: Flow (gpm) from 0 to 5
- Series: 3 lines for 1-row, 2-row, 3-row standard capacity coils
- Coil conditions: 8" Box, 250 CFM reheat, 63°F EAT, 90°F LAT (standard capacity)
- Key annotation: Chart title "Standard Capacity Coils - 8" Box - 250 CFM reheat - 63°F EAT - 90° LAT"

Structured Data (Machine Readable):
{
  "chart_type": "line",
  "metric": "HHW flow for 1-, 2-, and 3-row coils",
  "units": "gpm",
  "conditions": "8-inch box, 250 CFM reheat, 63°F EAT, 90°F LAT",
  "data": {
    "x_axis": "HWST (°F), range 115-195",
    "y_axis": "Flow (gpm), range 0-5",
    "series": ["1-Row Standard Coil Flow", "2-row Standard Coil Flow", "3-Row Standard Coil Flow"],
    "key_finding": "1-row coils require dramatically higher flow at lower HWST; 3-row coils maintain low flow across entire HWST range"
  }
}]
...
Given the moderate temperatures in WSHP hydronic loops, AWHPs are a good option for boiler retrofits in WSHP loops. The moderate supply water temperatures result in high heat pump capacity and efficiency. AWHPs also offer an opportunity to serve both the heating and cooling requirements for the WSHP loop. If including cost for an AWHP to replace the boiler, using it as a cooling source eliminates the water-use and maintenance requirements of a cooling tower. Use of an AWHP does represent an increase in energy use, and cooling towers may still be necessary to meet the load in cooling-dominated climates. However, where an AWHP can serve both the heating and cooling needs of the WSHP loop, eliminating the cooling tower provides additional operating cost savings to account for when evaluating the retrofit.
...
There is a variety of methods for defrost, and two common methods are reversing the heat pump cycle or using electric resistance heaters. Additional details of defrost cycles, including other methods (e.g., hot gas bypass defrost), are presented in *Decarbonizing Building Thermal Systems: A Guide for Heat Pump Systems and Beyond* (Houssainy et al. 2024). The type of air-source heat pump (RTU, AWHP, split, etc.) also affects how defrost may operate and what options are available.
...
[Figure: Cold Climate Air-Source Heat Pump Specification V4.0
Type: Image

Description:
A sidebar callout showing the cover and description of the Northeast Energy Efficiency Partnerships (NEEP) Cold Climate Air-Source Heat Pump Specification V4.0 (NEEP 2023a).

Key Elements:
- Document title → "Cold Climate Air-Source Heat Pump Specification V4.0"
- Publisher → Northeast Energy Efficiency Partnerships (NEEP) (2023a)
- Purpose → Designed to identify air-source heat pumps that are best suited to heat efficiently in cold climates (IECC climate zone 4 and higher). Intended for engineers, contractors, and other practitioners who need assurance that the equipment they select will serve the load efficiently throughout the ambient temperature range and to differentiate cold climate performance (NEEP 2023a).]
...
- **WSHPs with Ground-Source Loops.** WSHPs, presented in Section 6.1.3.5, provide an alternative heat pump technology for use in cold climates. When paired with ground source loops, particularly with vertical boreholes for stable ground temperature, a WSHP system is a very efficient and reliable solution that will operate well in very cold temperatures.
...
Description:
A photograph of multiple large air-source heat pump (ASHP) units installed indoors within a mechanical room at Montreal City Hall, showing the ASHP condensing units positioned within the indoor space with associated ductwork and piping connections.

Key Elements:
- Indoor ASHP units → multiple large-format ASHP condensing units installed within an enclosed mechanical room
- Mechanical room context → indoor installation providing warmer ambient air to heat pumps during cold weather
- Ductwork/piping → connections visible for refrigerant and air distribution

Image credit: Martin Roy & Associés]
...
Description:
A sidebar callout showing the cover of ASHRAE Guideline 36-2021 (supersedes ASHRAE Guideline 36-2018), *High-Performance Sequences of Operation for HVAC Systems*, published by ASHRAE.

Key Elements:
- Document title → "ASHRAE Guideline 36-2021: High-Performance Sequences of Operation for HVAC Systems"
- Publisher → ASHRAE (2021a)
- Status → Supersedes ASHRAE Guideline 36-2018; under continuous maintenance by a Standing Guideline Project Committee (SGPC)
- Purpose → Includes uniform advanced sequences of operation for HVAC systems, rather than custom control sequences created for each system or building. The standardized controls sequences in the guideline have been optimized to minimize energy use and maximize comfort and indoor air quality (ASHRAE 2021a).]
...
[Figure: Advanced Building Automation Systems: Best Practices Guide, Version 1.0
Type: Image

Description:
A sidebar callout showing the cover of the *Advanced Building Automation Systems: Best Practices Guide, Version 1.0* (Taylor Engineers 2022), published June 13, 2022.

Key Elements:
- Document title → "Advanced Building Automation Systems: Best Practices Guide, Version 1.0"
- Authors → Hwakong Cheng – Taylor Engineers; Brent Eubanks – Eubanks Engineering Research; Rupam Singla – TRC
- Publication date → June 13, 2022
- Purpose → Intended to serve as a resource for best practices in the implementation and operation of building automation systems (BAS) (Taylor Engineers 2022). Highlights key elements of ASHRAE Guideline 36 (ASHRAE 2021a) and addresses other key BAS topics, such as some of the knowledge barriers to achieving high-performance BAS.]
...
Description:
A sidebar callout showing the cover of the Lawrence Berkeley National Laboratory (LBNL) Monitoring-Based Commissioning (MBCx) Plan Template (Kramer and Granderson 2017).

Key Elements:
- Document title → "Monitoring-Based Commissioning (MBCx) Plan Template"
- Authors → Kramer and Granderson (2017)
- Publisher → Lawrence Berkeley National Laboratory (LBNL) — Building Technology and Urban Systems Division
- Purpose → Outlines the MBCx process for maintaining and continuously improving building and system performance. The MBCx plan drives a thorough and methodical MBCx process so stakeholders clearly understand their roles and responsibilities for sustaining performance (Kramer and Granderson 2017).]
...
[Figure: On-Site Commercial Solar PV Decision Guide
Type: Image

Description:
A sidebar callout showing the cover of the U.S. Department of Energy Better Buildings guide titled *On-Site Commercial Solar PV Decision Guide* (DOE 2014), published September 25, 2014.

Key Elements:
- Document title → "On-Site Commercial Solar PV Decision Guide"
- Publisher → U.S. Department of Energy, Better Buildings Initiative (DOE 2014)
- Publication date → September 25, 2014
- Audience → Commercial building owners, building energy managers, facility managers, and property managers across retail, food service, healthcare, higher education, and the public sector
- Purpose → Helps commercial building owners navigate the decisions regarding installing solar photovoltaics (PV) on commercial buildings. Intended for anyone investigating the addition of PV to a single or multiple commercial buildings (DOE 2014).]
...
[Figure: A Guide to Community Shared Solar: Utility, Private, and Nonprofit Project Development
Type: Image

Description:
A sidebar callout showing the cover of the guide *A Guide to Community Shared Solar: Utility, Private, and Nonprofit Project Development* (Coughlin et al. 2010), developed for the National Renewable Energy Laboratory.

Key Elements:
- Document title → "A Guide to Community Shared Solar: Utility, Private, and Nonprofit Project Development"
- Authors/Developers → Northwest Sustainable Energy for Economic Development, Keyes and Fox, Stoel Rives, and the Bonneville Environmental Foundation, for the National Renewable Energy Laboratory (Coughlin et al. 2010)
- Purpose → Updated version of the original Guide to Community Shared Solar (November 2010). A resource to plan, develop, and implement community-shared solar projects. Explores the range of incentives and policies for community solar projects while providing examples of operational community-shared solar projects (Coughlin et al. 2010).]
...
| Municipal Solid Waste Gas | The breakdown of organic waste materials at landfills produces a combination of methane and carbon dioxide known as landfill gas (LFG). | • Burning LFG produces site GHG emissions ("CO2 emissions from MSW landfills are not considered to contribute to global climate change because the carbon was contained in recently living biomass" [EPA 2024]); • Removes methane, which is a potent GHG; • Requires capture, treatment, and delivery of LFG from local MSW landfills; • Fossil fuel systems may be converted to burn LFG | U.S. EPA Landfill Methane Outreach Program |
...
Notes: These renewable generation sources are considered secondary to PV applications for decarbonization retrofits and are not likely to have widespread application.]
...
Shifting from grid source energy to cleaner generation through renewable resources such as solar and wind will influence grid emission factors throughout the day. The classic example of this is the "duck curve" shown below, demonstrating the impact of increased PV generation for the grid. Stand-alone BESS (not paired with on-site generation systems) provide a means to recover the overproduction of clean energy during the midday period and use it to power building HVAC systems during the afternoon/evening peak and morning warm-up periods.

[Figure: The "Duck Curve"
Type: Chart

Description:
A multi-line chart titled "Net load — March 31" showing the daily net electrical load profile for the California grid across multiple years (2012–2020), illustrating the classic "duck curve" shape that results from increased solar PV generation. The x-axis shows time of day from 12am to 9pm, and the y-axis shows net load in megawatts. Each year from 2012 to 2020 is shown as a separate line, with later years showing progressively deeper midday troughs and steeper evening ramps.

Data Representation:
- 2012 (actual): highest net load curve, relatively flat with modest midday dip; peak ~22,000 MW
- 2013 (actual): similar to 2012 with slight decrease
- 2014: midday trough deepening; net load ~14,000 MW at lowest
- 2015: further deepening of midday trough
- 2016: continued deepening
- 2017: continued deepening
- 2018: continued deepening
- 2019: continued deepening
- 2020: deepest midday trough; lowest net load ~12,000 MW at midday; evening ramp to ~26,000+ MW; annotations: "potential overgeneration" at midday trough and "increased ramp" at evening ramp

- Metric: Net electrical load (MW) by time of day for California grid, by year
- Chart Type: Line (multi-series)
- Units: Megawatts (MW)

Chart Generation Hint:
- X-axis: Time of day (12am, 3am, 6am, 9am, 12pm, 3pm, 6pm, 9pm)
- Y-axis: Megawatts (0–28,000)
- Series: Lines for each year 2012–2020; labeled directly on chart
- Key annotations: "potential overgeneration" arrow pointing to midday trough; "increased ramp" arrow pointing to steep evening ramp on 2020 line

Structured Data (Machine Readable):
{
  "chart_type": "line",
  "metric": "California grid net load - March 31 by year",
  "units": "Megawatts",
  "data": {
    "years": ["2012 (actual)", "2013 (actual)", "2014", "2015", "2016", "2017", "2018", "2019", "2020"],
    "approximate_midday_min_MW": {"2012": 18000, "2020": 12000},
    "approximate_evening_peak_MW": {"2012": 22000, "2020": 26000},
    "key_features": ["potential overgeneration at midday", "increased evening ramp rate in later years"]
  }
}

Image credit: California Independent System Operator (CAISO 2016)]

[Figure: California Battery Storage Trend: March 15, 2023
Type: Chart

Description:
A stacked bar/area chart showing California's grid battery storage charging and discharging activity in megawatts (MW) on an hourly basis over March 15, 2023. The chart shows two data series: Discharging (positive values, dark blue) and Charging (negative values, light blue). The x-axis shows the time of day from 0:00 to 23:00, and the y-axis ranges from approximately −2500 to +2500 MW.

Data Representation:
- Discharging (dark blue, positive): peaks observed in two main periods — morning (~7:00–9:00, peak ~1250–2500 MW) and evening (~17:00–22:00, peak ~1500–2500 MW)
- Charging (light blue, negative): primary charging period during midday (~9:00–15:00, reaching approximately −1250 to −2500 MW); corresponds to solar overproduction period in duck curve

- Metric: Battery storage charging and discharging activity (MW)
- Chart Type: Bar/Area (dual series: positive discharging, negative charging)
- Units: Megawatts (MW)

Chart Generation Hint:
- X-axis: Time of day (0:00–23:00)
- Y-axis: MW (−2500 to +2500)
- Series: Discharging (positive, dark blue), Charging (negative, light blue)
- Key annotations: Legend distinguishing Discharging vs. Charging

Structured Data (Machine Readable):
{
  "chart_type": "bar",
  "metric": "California battery storage trend March 15 2023",
  "units": "MW",
  "data": {
    "discharging_peak_MW": 2500,
    "charging_peak_MW": -2500,
    "primary_charging_period": "9:00-15:00 (solar overproduction period)",
    "primary_discharging_periods": ["7:00-9:00 (morning warm-up)", "17:00-22:00 (evening peak)"]
  }
}
...
Description:
A stacked bar chart titled "System Cost of 300-kW Lithium Ion Battery System" showing the installed system capital cost ($/kW, 2021 USD) for a 300-kW lithium-ion BESS across five storage durations (1-hour through 8-hour), with each bar broken into cost components stacked vertically.

Data Representation:
- 1-hour Duration, 300-kWh: $1,645/kW total
- 2-hour Duration, 600-kWh: $2,035/kW total
- 4-hour Duration, 1200-kWh: $2,687/kW total
- 6-hour Duration, 1800-kWh: $2,888/kW total
- 8-hour Duration, 2400-kWh: $3,295/kW total

Cost components (stacked, bottom to top):
...
- Metric: Installed system capital cost ($/kW, 2021 USD) for 300-kW lithium-ion BESS by storage duration
- Chart Type: Stacked Bar
- Units: $/kW (2021 USD)

Chart Generation Hint:
- X-axis: Storage duration categories (1-hour/300-kWh, 2-hour/600-kWh, 4-hour/1200-kWh, 6-hour/1800-kWh, 8-hour/2400-kWh)
- Y-axis: Installed System Capital Cost ($/kW, 2021 USD), range $0–$4,000
- Series: 8 stacked cost component categories
- Key annotations: Total cost labels at top of each bar ($1,645; $2,035; $2,687; $2,888; $3,295)

Structured Data (Machine Readable):
{
  "chart_type": "bar",
  "metric": "Installed system cost of 300-kW lithium-ion BESS by duration",
  "units": "$/kW (2021 USD)",
  "data": {
    "1-hour (300-kWh)": 1645,
    "2-hour (600-kWh)": 2035,
    "4-hour (1200-kWh)": 2687,
    "6-hour (1800-kWh)": 2888,
    "8-hour (2400-kWh)": 3295
  },
  "cost_components": ["Lithium-ion Battery Cabinet", "Battery Inverter", "Structural BOS", "Electrical BOS",
                       "Install Labor & Equipment", "EPC Overhead", "Sale Tax", "Developer Cost + Profit"]
}

Image credit: NREL (2023a)]
...
[Figure: On-Site Energy Storage Decision Guide
Type: Image

Description:
A sidebar callout showing the cover of the U.S. Department of Energy Better Buildings guide *On-Site Energy Storage Decision Guide* (April 2017).

Key Elements:
- Document title → "On-Site Energy Storage Decision Guide"
- Publisher → U.S. Department of Energy, Better Buildings / ENERGY (April 2017)
- Audience → Commercial building owners and managers, building energy managers, facility managers, and property managers across various sectors
- Purpose → Helps commercial building owners and managers investigate the addition of energy storage to a single or multiple commercial buildings. A variety of incentives, metering capabilities, and financing options exist for installing energy storage at a facility. Energy storage is not suitable for all business types or all regions due to variations in weather profiles, load profiles, electric rates, and local regulations.]

[Figure: Handbook on Battery Energy Storage Systems
Type: Image

Description:
A sidebar callout showing the cover of the Asian Development Bank (ADB) publication *Handbook on Battery Energy Storage System* (ADB 2018), published December 2018.

Key Elements:
- Document title → "Handbook on Battery Energy Storage System"
- Publisher → Asian Development Bank (ADB 2018)
- Publication date → December 2018
- Purpose → Outlines the various battery energy storage technologies, their application, and the caveats to consider in their development. Discusses the economic as well as financial aspects of battery energy storage system projects and provides examples from around the world (ADB 2018).]
...
[Figure: IEEE STD 2030.2.1, Guide for Design, Operation, and Maintenance of Battery Energy Storage Systems, both Stationary and Mobile, and Applications Integrated with Electric Power Systems
Type: Image

Description:
A sidebar callout showing the cover of the IEEE Standard 2030.2.1-2019, *Guide for Design, Operation, and Maintenance of Battery Energy Storage Systems, both Stationary and Mobile, and Applications Integrated with Electric Power Systems* (IEEE 2019), developed by IEEE Standards Coordinating Committee 21 on Fuel Cells, Photovoltaics, Dispersed Generation, and Energy Storage.

Key Elements:
- Document title → "IEEE Guide for Design, Operation, and Maintenance of Battery Energy Storage Systems, both Stationary and Mobile, and Applications Integrated with Electric Power Systems"
- Standard number → IEEE Std 2030.2.1™-2019
- Developer → IEEE Standards Coordinating Committee 21 on Fuel Cells, Photovoltaics, Dispersed Generation, and Energy Storage (IEEE 2019)
- Purpose → Provides alternative approaches and practices for design, operation, maintenance, integration, and interoperability, including distributed resources interconnection of stationary or mobile BESS with the electric power system(s) at customer facilities, electricity distribution facilities, or bulk transmission electricity facilities (IEEE 2019).]
...
Description:
An infographic diagram illustrating four bidirectional EV charging scenarios, arranged as four horizontal rows with descriptive text on the left and an icon illustration on the right for each scenario.

Key Elements:
- Scenario 1 (Hazard Backup): Plug in your bidirectional vehicle to recharge the battery for during a hazard → EV connected to charging station icon, battery icon shown
- Scenario 2 (Renewable Charging): Charging a bidirectional vehicle when renewable production exceeds the building demand is an opportunity to store electricity in the vehicle to drive or use as a battery → Solar panel + wind turbine + EV charging station + car icons shown
- Scenario 3 (V2B — Vehicle to Building): V2B saves money by reducing power consumption in the building. Energy can be drawn from the EV when the battery is full → "V2B" label, building + EV charging station + car icons shown
- Scenario 4 (V2G — Vehicle to Grid): V2G utility partnerships can make money by sending energy back onto the grid, regulating loads and providing energy during hazards. A fleet-as-a-service model can pay for the vehicle and charger over time → "V2G" label, grid transmission tower + EV charging station + car icons shown
...
Grid-interactive systems can range from a single distributed energy resource (DER) connected at a local load to complicated systems with multiple DERs serving a large campus. The basic requirement of grid-interactive systems is to incorporate grid signals into the control of building loads, generation, or storage systems, while maintaining building services and occupant comfort. Grid signals include time-varying carbon emission factors, demand response calls, and dynamic utility rates. Incorporating data from these signals into the design phase of retrofit projects will help identify control strategies that can reduce emissions and costs and ensure that equipment and system selections are able to achieve the communication and connectivity required for grid-interactivity. Co-optimizing control strategies to minimize cost and carbon is recommended, as these signals are often, but not always, correlated. Grid-interactive systems can have a wide array of stakeholders, ranging from building owners, building tenants, facility managers, and third-party DER owners or operators to utility providers. Coordination across these stakeholders is critical to ensure that grid-interactive operation is safe, reliable, and comfortable, while reducing emissions and costs. See ASHRAE's *Grid-Interactive Buildings for Decarbonization: Design and Operation Resource Guide* (ASHRAE 2023h) for details on grid-interactive design for different building systems, ranging from stand-alone devices to integrated systems with central controllers.

[Figure: Distributed Generation and Energy Storage Sizing Tools
Type: Descriptive Diagram

Description:
A sidebar callout describing free software tools developed by DOE National Laboratories for optimizing the sizing and trade-offs between various distributed generation and energy storage systems.

Key Elements:
- Context → Several software tools and methods exist for optimizing the sizing and other trade-offs between various distributed generation and energy storage systems. These tools consider utility tariffs, relative costs, and coordinated dispatch across these resources to optimize system selections, sizes, and configurations. Paid tools are available to support these design decisions.
- Tool 1 → Renewable Energy Integration and Optimization Tool (REopt®): Developed and used by NREL to optimize energy systems for buildings, campuses, communities, microgrids, etc. Available at https://reopt.nrel.gov/ (NREL 2023d).
- Tool 2 → Distributed Energy Resources Customer Adoption Model (DER-CAM): Developed and used by Lawrence Berkeley National Laboratory as a powerful and comprehensive decision support tool that primarily serves the purpose of finding optimal distributed energy resource (DER) investments in the context of either buildings or multi-energy microgrids. Available at https://gridintegration.lbl.gov/der-cam (LBNL 2023).]
...
Description:
A sidebar callout showing the cover of the book *Thermal Energy Storage: Systems and Applications, Third Edition* (Dinçer and Rosen 2021), published by Wiley.

Key Elements:
- Document title → "Thermal Energy Storage: Systems and Applications, Third Edition"
- Authors → Ibrahim Dinçer and Marc A. Rosen (2021)
- Publisher → Wiley
- Purpose → Provides engineers with up-to-date information on methods, models, and approaches in TES systems and their applications in thermal management and elsewhere. Contains detailed coverage of integrated systems with energy storage options, environmental impact and sustainability, design, analysis, assessment criteria, advanced tools in exergy and extended exergy, and more. New and expanded chapters address topics such as renewable energy systems in which thermal energy storage is essential; sensible and latent TES systems; and numerical modeling, simulation, and analysis of TES systems (Dinçer and Rosen 2021).]
...
Hot-water TES can be used to shave or level the heating load met by heat pumps or even existing boilers. The heating system operates with a relatively constant heat output that is less than the peak building heating load and greater than the minimum heating load. The TES system recovers excess heat produced during periods of lower heating load and discharges it during the peak heating load period. TES effectively increases the capacity of the heating system. This can be a key strategy for existing building decarbonization retrofits. Including a hot-water TES system allows heat pump equipment to be sized to meet a reduced heating load. Reducing heat pump size can be important when space constraints on rooftops or in mechanical rooms restrict equipment sizes. For rooftop equipment where structural loads are a concern, reducing heat pump size and weight can avoid the need for structural upgrades to the building roof.

[Figure: HHW Peak Shaving with TES
Type: Chart

Description:
A stacked bar chart titled "Thermal Storage" showing hourly heating hot-water (HHW) generation (in MBh) over a 24-hour period on a winter day (Month 21, Day 21), differentiated by three operational modes: Using Stored Heat, Charging Heat Storage, and Heat Pump Heating. The x-axis shows time of day from 12 AM to 11 PM, and the y-axis shows Hot Water Generation (MBh) from 0 to 30,000. Three bars (or bar segments) represent the three operating modes for each hour.

Data Representation:
- Using Stored Heat (white/unfilled bar): energy discharged from TES during peak heating periods (early morning and evening)
- Charging Heat Storage (orange-outlined bar): excess heat produced by heat pump during off-peak periods stored in TES
- Heat Pump Heating (solid red bar): direct heat pump output to meet building load

- Metric: Hourly heating hot-water generation (MBh) by source/mode
- Chart Type: Stacked Bar
- Units: MBh (thousand BTU per hour)

Chart Generation Hint:
- X-axis: Hour of day (12 AM through 11 PM, labeled as AM/PM)
- Y-axis: Hot Water Generation (MBh), range 0–30,000
- Series: Using Stored Heat (white), Charging Heat Storage (orange outline), Heat Pump Heating (red solid)
- Key annotations: Chart title "Thermal Storage"; legend identifying three series; x-axis labeled "Winter Month | Day | Hour" with "21" beneath hour labels

Structured Data (Machine Readable):
{
  "chart_type": "bar",
  "metric": "Hourly HHW generation by operating mode (peak shaving with TES)",
  "units": "MBh",
  "data": {
    "series": ["Using Stored Heat", "Charging Heat Storage", "Heat Pump Heating"],
    "period": "Winter, Day 21, 24-hour profile",
    "y_range": "0-30,000 MBh"
  }
}
...
Description:
A mechanical room floor plan drawing showing an example rooftop/mechanical room layout for an HVAC system that includes a hot-water TES (TES-HW) tank, multiple air-source heat pumps (ASHPs), electrical service/transformers, and distributed energy resources (DERs). Dimensions are annotated on the drawing. A screen wall and clearance for appropriate sound levels are also indicated.

Key Elements:
- TES-HW (Thermal Energy Storage — Hot Water) → large rectangular tank occupying northeast quadrant of the layout, approximately 35'-0" wide
- ASHP units → six air-source heat pump units arranged in two rows, each spaced approximately 10'-0" apart
- Electrical Service/Transformers → three electrical service/transformer enclosures located on west side and south side of layout
- DER (Distributed Energy Resources) → two DER units located in southeast area of layout
- Screen Wall → indicated at northeast perimeter
- Clearance for appropriate sound levels → noted at east boundary
- Overall layout dimensions → approximately 130'-0" × 113'-0" outer boundary; inner equipment zone approximately 104'-0" × 130'-0"
...
[Figure: ASHRAE Design Guide for Cool Thermal Storage, Second Edition
Type: Image

Description:
A sidebar callout showing the cover of the ASHRAE publication *ASHRAE Design Guide for Cool Thermal Storage, Second Edition* (Glazer 2019), associated with ASHRAE Research Project RP-1719.

Key Elements:
- Document title → "ASHRAE Design Guide for Cool Thermal Storage, Second Edition"
- Author → Jason Glazer, PE, BEMP (2019)
- Publisher → ASHRAE (RP-1719)
- Purpose → Provides design engineers with the latest information in designing, modeling, costing, and commissioning cool thermal energy storage systems. With a particular focus on ice and chilled water systems, this guide is a comprehensive, first-level reference that discusses thermal energy storage fundamentals, compares thermal energy storage technologies, and describes an applications-focused procedure for designing cool thermal energy storage systems (Glazer 2019).]
...
Hot-water and chilled-water TES systems store water at the temperatures needed for heating and cooling end uses. These systems can require substantial insulation and must be charged using chilled water or hot water directly produced by HVAC equipment. Condenser water TES systems instead store water at temperatures closer to 80°F (26.7°C). The condenser water TES does not serve heating and cooling loads directly; instead, it serves as a heat sink for chillers and heat pumps and a heat sink/source for water-cooled heat recovery chillers. These systems have good applications in buildings with diurnal temperature swings when heating and cooling are needed. During cooling periods, both chillers and heat recovery chillers reject heat into the tank (and cooling tower) as needed. During heating periods, the heat recovery chiller supplies heat to the building and rejects chilled water to the TES tank. These systems can be a very effective solution in many existing building retrofits. The *ASHRAE Journal* article "Solving the Large Building All-Electric Heating Problem" provides an excellent reference (Gill 2021).

[Figure: Direction of Heat Flow for Condenser Water TES
Type: Descriptive Diagram

Description:
A schematic flow diagram showing the direction of heat flow (CHW — chilled water, HW — hot water, CW — condenser water) between three main equipment components in a condenser water TES system: a High Efficiency Centrifugal chiller, a Water Cooled Heat Recovery Screw Chiller, and a Condenser Water TES tank, along with a 2-Pipe Air Source Heat Pump.

Key Elements:
- High Efficiency Centrifugal → chiller providing chilled water; rejects condenser heat to Condenser Water TES
- Water Cooled Heat Recovery Screw Chiller → simultaneously produces chilled water and hot water; rejects to and receives from Condenser Water TES
- Condenser Water TES → central thermal buffer tank storing condenser water at ~80°F (26.7°C); receives heat from chillers during cooling periods; supplies heat source to heat recovery chiller during heating periods
- 2-Pipe Air Source Heat Pump → provides supplemental heating/cooling to the system
- KEY: CHW = Chilled Water; HW = Hot Water; CW = Condenser Water

Image credit: Taylor Engineers, Inc.]
...
Where an existing building has a large thermal mass, such as concrete walls or masonry, building-mass thermal storage may be explored to take advantage of the existing building structure. Building thermal storage is the usage of building mass (i.e., the structure and furnishings) as thermal storage materials. This strategy is only applicable to certain existing buildings and would not be a retrofit strategy. Hourly analysis of building heating and cooling loads will be required to understand whether the building thermal mass can store sufficient energy to appreciably serve cooling or heating loads.
...
[Table: Table 7.2 LHS Thermal Storage Media
Type: Table
...
Notes: Table 7.2 provides thermal storage medium properties for latent heat storage (LHS) systems including temperature ranges, density, specific heat, relative cost, and key characteristics.]
...
Description:
A schematic diagram illustrating an ambient loop district energy system interconnecting multiple building types, renewable energy sources, and thermal storage. The diagram shows seasonal heating/cooling flows (Winter and Summer labels), energy flows between dwellings, industry, stores & offices, and renewable energy systems, with a central storage system for temporal load balancing.

Key Elements:
- Dwellings (Heating dominated) → residential buildings connected to loop; exchange space heating and cooling seasonally
- Industry → industrial process heat source connected to the loop
- Stores & Offices (Balanced over the year) → commercial buildings with relatively balanced annual heating/cooling loads
- Renewable heat sources → solar thermal, heat pump shown providing renewable heat input to loop
- Renewable electricity sources → wind turbine and solar PV providing renewable electricity
- Storage (for temporal unbalance) → large thermal storage tanks (hot and cold) providing seasonal/short-term storage to balance loop temperatures
- Winter → heating energy flow direction shown
- Summer → cooling energy flow direction shown
- Seasonal and simultaneous heat and cold demand → label indicating the demand profile served by the ambient loop
...
**energy usage intensity (EUI).** An expression of the annual energy used or calculated to be used by a building or building space per unit of gross floor area. Expressed in MBtu/ft²·yr (Watt-h/m²·yr).
...
Description:
A decision tree for guiding near-term heating system replacement decisions at UCSC campus buildings. The flowchart begins with the question "How is the project heated today?" and branches through a series of questions about building size, scope, and decarbonization station availability, ultimately directing users to one of several replacement options including connecting to a decarbonization station, installing a small ASHP, replacing with a condensing boiler, or replacing with a stand-alone electric system. Interim options are also identified for cases where full electrification is not yet feasible.

Process Steps:
1. How is the project heated today? → branches to: Gas boilers / Electric heating / Direct-fired gas system (Existing Heating)
2. Under 3 floors and 25,000 sf? → Yes: Replace with a stand-alone electric system; No: proceed
3. Only replacing the boiler? → Yes: proceed to sizing/scope questions; No: Does a Decarbonization Station exist? → Yes: Connect into the Decarbonization Station; No: Start a Decarbonization Station → Yes (connect to building group)
4. Is the heating demand >500 MBh? → Yes: proceed; No: Is there medium voltage electrical capacity? → Yes: Will the building be electrified in >7 years? → Yes: Replace a condensing boiler; No: Replace a condensing boiler; No: Replace with a small air source heat pump
5. Funding to electrify? → Yes: Demolish ASHP/boiler; No: Replace with a small air source heat pump ($$$ shown for cost indication)
6. Interim options column: Replace a condensing boiler / Replace a condensing boiler / Replace a conventional boiler

Flow Logic:
- Start: "How is the project heated today?"
- Left branch (Size, scope & timeline): Routes through building size and replacement scope checks
- Right branch (Interim options): Shows cost-indicated interim pathways ($$$ labels) with condensing and conventional boiler options
- Decision: If Decarbonization Station exists → Connect to it; else → Start a new one

Key Components:
- "How is the project heated today?" → entry point
- "Connect into the Decarbonization Station" → preferred long-term outcome
- "Replace with a stand-alone electric system" → small building solution
- "Replace with a small air source heat pump" → immediate electrification path
- "Replace a condensing boiler" → interim/bridge solution
- "$$$" labels → indicate relative cost thresholds for decision branches
...
Structured Flow (Machine Readable):
{
  ...
  "steps": [
    ...
    "Under 3 floors and 25,000 sf?",
    "Only replacing the boiler?",
    "Does a Decarbonization Station exist?",
    "Is the heating demand >500 MBh?",
    "Is there medium voltage electrical capacity?",
    "Will the building be electrified in >7 years?",
    "Funding to electrify?"
  ],
  "decisions": [
    {"condition": "Under 3 floors and 25,000 sf?", "yes": "Replace with stand-alone electric system", "no": "Only replacing the boiler?"},
    {"condition": "Only replacing the boiler?", "yes": "Heating demand >500 MBh?", "no": "Decarbonization Station exist?"},
    {"condition": "Decarbonization Station exist?", "yes": "Connect into Decarbonization Station", "no": "Start a Decarbonization Station"},
    {"condition": "Heating demand >500 MBh?", "yes": "Funding to electrify?", "no": "Medium voltage electrical capacity?"},
    {"condition": "Medium voltage electrical capacity?", "yes": "Building electrified in >7 years?", "no": "Replace with small ASHP"},
    {"condition": "Building electrified in >7 years?", "yes": "Replace condensing boiler", "no": "Replace condensing boiler"},
    {"condition": "Funding to electrify?", "yes": "Demolish ASHP/boiler", "no": "Replace with small ASHP"}
  ]
}
...
[Table: 345 Hudson Project Summary
Type: Table
...
Notes: Key project parameters for the 345 Hudson decarbonization retrofit.]
...
- Floor-by-floor replacement of packaged terminal units by DOAS for fresh air supply with minimum 85% heat recovery. This keeps the heat within the building and minimizes energy input for heating and cooling of ventilation.
...
Description:
A bar chart titled "Relative NPV of Alternatives (For the selected analysis period)" comparing the relative net present value (NPV) in millions of dollars for five scenarios: two BAU baselines and three retrofit alternatives. The two baseline scenarios show negative NPV values, while the three alternatives show positive NPV values, with Alternative 1 and Alternative 2 achieving approximately $14 million NPV and Alternative 3 approximately $10 million NPV.

Data Representation:
- Baseline - Reactive Fines: approximately −$1.5 million (negative, shown in purple/blue)
- Baseline - Offset Based Compliance: approximately −$1.5 million (negative, shown in blue)
- Alternative 1: approximately $14 million (positive, shown in green)
- Alternative 2: approximately $14 million (positive, shown in orange/red)
- Alternative 3: approximately $10 million (positive, shown in yellow)

- Metric: Relative NPV of project alternatives
- Chart Type: Bar
- Units: Million $

Chart Generation Hint:
- X-axis: Scenario names (Baseline - Reactive Fines, Baseline - Offset Based Compliance, Alternative 1, Alternative 2, Alternative 3)
- Y-axis: Million $ (range approximately −4 to 16)
- Key annotations: Chart title "Relative NPV of Alternatives (For the selected analysis period)"
...
Structured Data (Machine Readable):
{
  ...
  "units": "Million $",
  "data": {
    "Baseline - Reactive Fines": -1.5,
    "Baseline - Offset Based Compliance": -1.5,
    "Alternative 1": 14,
    "Alternative 2": 14,
    "Alternative 3": 10
  }
...
Description:
A multi-line chart titled "Carbon Emissions Per Year (Before Offsets)" showing projected annual CO2-equivalent emissions (Tons of CO2eq/year) for five scenarios from 2021 to 2041. The chart shows all scenarios declining over time, with baseline scenarios declining slowly while the three retrofit alternatives decline steeply. An "Emissions Target" dashed line is also shown as a reference. Key insight: Alternative 1 achieves the lowest emissions trajectory, followed by Alternative 2 and Alternative 3, all well below the LL97 emissions target by 2030.

Data Representation:
- Alternative 2 (red solid line): starts ~5,000 tCO2eq/yr in 2021, declines steeply to ~500 tCO2eq/yr by 2041
- Alternative 1 (green solid line): starts ~5,000 tCO2eq/yr in 2021, declines steeply to ~300 tCO2eq/yr by 2041
- Alternative 3 (yellow/orange solid line): starts ~5,000 tCO2eq/yr in 2021, declines to ~700 tCO2eq/yr by 2041
- Baseline - Reactive Fines (blue solid line): starts ~5,000 tCO2eq/yr in 2021, slow decline to ~1,000 tCO2eq/yr by 2041
- Baseline - Offset Based Compliance (blue solid line): similar to Reactive Fines baseline trajectory
- Emissions Target (dashed line): shown at approximately 4,000 tCO2eq/yr in 2029, then drops to approximately 1,000 tCO2eq/yr for 2030+

- Metric: Annual carbon emissions (Tons of CO2eq/year)
- Chart Type: Line
- Units: Tons of CO2eq/year

Chart Generation Hint:
- X-axis: Year (2021–2041)
- Y-axis: Tons of CO2eq/year (0–8,000)
- Series: Alternative 1 (green), Alternative 2 (red), Alternative 3 (yellow), Baseline - Reactive Fines (blue), Baseline - Offset Based Compliance (blue), Emissions Target (dashed)

Structured Data (Machine Readable):
{
  "chart_type": "line",
  "metric": "Annual carbon emissions before offsets",
  "units": "Tons of CO2eq/year",
  "data": {
    "x_axis": "Year (2021–2041)",
    "series": ["Alternative 1", "Alternative 2", "Alternative 3", "Baseline - Reactive Fines", "Baseline - Offset Based Compliance", "Emissions Target (dashed)"],
    "note": "Approximate values read from chart; exact data points not recoverable"
  }
}]
...
Description:
A Gantt-style timeline chart showing the phasing schedule for the 345 Hudson decarbonization retrofit from 2020 to 2030. Activities are listed along the left vertical axis with horizontal bars indicating the timeframe for each phase. Key milestones and phase sequences are shown along the top of the chart.

Data Representation:
- Data Strategy - Connect Everything: 2020–2022
- Replace Primary AHU with High Energy Recovery: 2021–2022
- Deep Retrofit Floors 2, 3, 7, 8, 9: 2022
- Move To Ambient Loop (Add ASHP And Dry Coolers): 2022
- Enable Data And AI Solutions: 2022
- Connect Thermal Storage - Water Tanks: 2023–2024
- Connect To 555 GW To Share Energy: 2023–2025
- Deep Retrofit Floors 10, 11, 13, 16, & 17: 2026–2027
- Deep Retrofit Floors 4, 5, 6, 12, 14, & 15: 2028–2029
- Complete Ambient Loop - 100% Electric Building: 2030

- Metric: Project phase timeline
- Chart Type: Gantt/Timeline Bar
- Units: Years (2020–2030)

Structured Data (Machine Readable):
{
  "chart_type": "bar",
  "metric": "345 Hudson project phasing timeline",
  "units": "Year",
  "data": {
    "Data Strategy - Connect Everything": "2020–2022",
    "Replace Primary AHU with High Energy Recovery": "2021–2022",
...
[Table: San Diego State University Project Summary
Type: Table
...
Notes: Key project parameters for the SDSU central plant decarbonization assessment.]
...
Data:
| Bldg | Use | Heating Capacity, Mbh (Existing Equipment Sizing) | Heating Capacity, Btu/h Per ft² (Existing Equipment Sizing) | Peak Demand, Mbh (Analyzed Equipment Sizing) | Peak Demand, Btu/h per ft² (Analyzed Equipment Sizing) |
|---|---|---|---|---|---|
...
Notes: * Upon completion of the system upgrades, including replacement of three-way valves and temperature resets, the measured peak demand was 10 Btu/h·per ft².]
...
[Figure: CS3.1 — Operational carbon analysis
Type: Chart

Description:
A bar chart titled "Operational Carbon Emissions Savings — Heating Plant Electrification" comparing annual CO2 emissions (in Tons) for four scenarios: Base Case (gas-fired boilers), Option 1 (All-Electric HP), Option 2 (All-Electric HR Chiller), and Option 3 (Hybrid Plant). The chart shows a clear reduction in operational carbon from the base case across all three alternatives.

Data Representation:
- Base Case: Gas-fired Boilers: 608 Tons CO2
- Option 1: All-Electric HP: 326 Tons CO2
- Option 2: All-Electric HR Chiller: 138 Tons CO2
- Option 3: Hybrid Plant: 236 Tons CO2

- Metric: Annual CO2 Emissions (Tons)
- Chart Type: Bar
- Units: Tons CO2

Chart Generation Hint:
- X-axis: Scenario names (Base Case: Gas-fired Boilers, Option 1: All-Electric HP, Option 2: All-Electric HR Chiller, Option 3: Hybrid Plant)
- Y-axis: CO2 Emissions (Tons), range 0–700
- Key annotations: Data labels on each bar (608, 326, 138, 236)

Structured Data (Machine Readable):
{
  "chart_type": "bar",
  "metric": "Operational carbon emissions savings — heating plant electrification",
  "units": "Tons CO2",
  "data": {
    "Base Case: Gas-fired Boilers": 608,
    "Option 1: All-Electric HP": 326,
    "Option 2: All-Electric HR Chiller": 138,
    "Option 3: Hybrid Plant": 236
  }
}

Image credit: Del Monaco 2023]
...
Description:
An exterior photograph showing The Heritage buildings before the retrofit. The image shows two high-rise residential towers rising above a lower mid-rise building, situated at the northeastern corner of Central Park in New York City. The buildings are brick construction typical of 1970s multifamily residential towers.

Key Elements:
- High-rise towers → Two 35-story brick residential towers at 1295 and 1309 Fifth Avenue
- Mid-rise building → 11-story building at 1660 Madison Avenue visible in the background/adjacent
- Street-level context → Urban streetscape at the northeastern edge of Central Park]
...
Description:
A side-by-side photograph showing facade upgrade work at The Heritage buildings. The left image shows a view of the high-rise tower before or during facade upgrade work. The right image shows workers and scaffolding during the installation of the exterior insulated facade system (EIFS), with prefabricated insulation panels being attached to the building exterior.

Key Elements:
- Left image → High-rise tower exterior showing existing masonry facade before EIFS overcladding
- Right image → Construction scaffolding and workers installing prefabricated insulated metal panels and EIFS to the building exterior]

[Table: The Heritage Project Summary
Type: Table
...
| Site | The Heritage |
| Year Built | 1975 |
| Location | 1295 and 1309 Fifth Avenue; 1660 Madison Avenue |
| City | New York |
| NYSERDA Funding | $5 million |
| Implementation Phase | 2021–2024 |
| L+M Private Investment | $13.7 million |

Notes: Key project parameters for The Heritage decarbonization retrofit.]
...
Description:
An exterior photograph of the Bloedel Conservatory in Vancouver's Queen Elizabeth Park, showing the distinctive geodesic domed structure illuminated at night with a fountain visible in the foreground. The dome is constructed of interlocking panels and glows with warm light from within.

Key Elements:
- Geodesic dome structure → The primary domed conservatory building with its characteristic triangulated panel facade
- Fountain → Water feature in the foreground reflecting the building's lighting
- Nighttime illumination → Warm interior lighting visible through dome panels]

[Table: Bloedel Conservatory Project Summary
Type: Table

Data:
| Field | Value |
|---|---|
| Project Name | Bloedel Conservatory |
| Year Built | 1969 |
| Location | Vancouver, British Columbia (Canada) |
| Building Size | 19,600 ft² |
| Project Phase | Implemented, 2021 |
| Year Last Systems Upgrade | N/A |

Notes: Key project parameters for the Bloedel Conservatory central plant retrofit.]
...
Description:
A grouped bar chart showing monthly natural gas consumption (in GJ) for Bloedel Conservatory from October 2021 through October 2023, comparing three series: Baseline (pre-retrofit), Post-retrofit Actual, and Post-Retrofit Savings. The chart shows a dramatic reduction in natural gas consumption following the AWHP retrofit, with the largest savings occurring in winter months (high heating demand) and minimal gas use in summer months post-retrofit.

Data Representation:
- Baseline (dark bars): Monthly gas consumption ranging from approximately 200–1,200 GJ during heating months
- Post-retrofit Actual (medium bars): Dramatically reduced gas consumption, typically below 400 GJ even in peak heating months
- Post-Retrofit Savings (dashed outline bars): The difference between baseline and actual, representing avoided gas use
...
Chart Generation Hint:
- X-axis: Month (Oct 2021 through Oct 2023)
- Y-axis: Natural Gas Consumption (GJ), range 0–1,400
- Series: Baseline, Post-retrofit Actual, Post-Retrofit Savings (dashed)
- Key annotations: Legend identifying three series; 75% overall gas reduction headline
...
Structured Data (Machine Readable):
{
  ...
  "units": "GJ",
  "data": {
    "note": "Monthly values approximate; peak baseline ~1,200 GJ in winter; post-retrofit peak ~400 GJ; 75% overall reduction"
  }
}]
...
Description:
A grouped bar chart showing monthly electricity consumption (in kWh) for Bloedel Conservatory from September 2021 through October 2023, comparing three series: Baseline (pre-retrofit), Post-Retrofit Increase, and Post-retrofit Savings. The chart shows an increase in electricity consumption following the AWHP retrofit (especially in winter heating months) as the heat pump uses electricity instead of gas, while also showing that overall energy costs and emissions are reduced.

Data Representation:
- Baseline (dark bars): Monthly electricity consumption ranging from approximately 100,000–150,000 kWh
- Post-Retrofit Increase (hatched bars): Additional electricity consumed post-retrofit, primarily in winter months, indicating the AWHP drawing more power for heating
- Post-retrofit Savings (dashed outline bars): Electricity savings from efficiency improvements in cooling
...
Chart Generation Hint:
- X-axis: Month (Sep 2021 through Oct 2023)
- Y-axis: Electricity Consumption (kWh), range 0–250,000
- Series: Baseline, Post-Retrofit Increase (hatched), Post-retrofit Savings (dashed)
- Key annotations: Legend identifying three series
...
Structured Data (Machine Readable):
{
  ...
  "units": "kWh",
  "data": {
    "note": "Monthly values approximate; baseline ~100,000–150,000 kWh; post-retrofit winter months show increases up to ~200,000 kWh due to AWHP heating load"
  }
}]
...
Description:
An exterior photograph of the StopWaste office building in Oakland, California. The building is a modest two-story structure with a classical-style facade, large windows, and prominent columns at the entrance. The address number 1537 is visible. The building is situated on a city street with trees lining the sidewalk.

Key Elements:
- Building facade → Classical-style two-story office building with decorative columns
- Address signage → "1537" visible at entrance
- Street-level context → Urban Oakland streetscape with parked cars and street trees]

[Table: StopWaste Project Summary
Type: Table

Data:
| Field | Value |
|---|---|
| Project Name | StopWaste |
| Year Built | Major Renovation in 2006 |
| Location | Oakland, California |
| Building Size | 13,845 ft² |
| Project Phase | Bidding, January 2024 |
| Year Last Systems Upgrade | 2006 |

Notes: Key project parameters for the StopWaste office HVAC decarbonization retrofit.]
...
Description:
An exterior photograph of Montreal City Hall (Hôtel de Ville de Montréal), a French Second Empire-style historic building featuring an elaborate stone facade with columns, arched windows, ornate cornices, a central clock tower, and a mansard roof with dormers. The building is photographed from the street level showing its full front elevation.

Key Elements:
- French Second Empire facade → Elaborate stone facade with columns, pilasters, and arched windows
- Central clock tower → Prominent tower rising above the roofline
- Mansard roof → Steeply pitched roof with dormer windows
- Ornate stonework → Decorative cornices, balustrades, and carved stone details throughout the facade]

[Table: Montreal City Hall Project Summary
Type: Table
...
| Size | 220,000 ft² |
| Year Built | 1924 |
| Location | 275 Notre-Dame St. East |
| City | Montreal, Quebec, Canada |
| Budget | $160 million |
| Implementation Phase | 2020–2024 |

Notes: Key project parameters for the Montreal City Hall decarbonization retrofit.]
...
Description:
A schematic diagram showing the Montreal City Hall HVAC system design, illustrating the interconnections between the main system components. The diagram uses line and box notation to show fluid flow paths for the heating, cooling, and ventilation systems. The layout shows components positioned as they would be installed in the building: outdoor dry cooler and DOAS heat recovery wheel at the top (rooftop/outdoor level), insulated mechanical room containing the ASHP, refrigerant-water heat exchanger, electric boiler, WSHP, and magnetic chiller at the central level, and radiant loops distributed to the building spaces.

Key Elements:
- Dry Cooler → outdoor heat rejection unit on roof; rejects excess heat from cooling operations
- DOAS Heat Recovery Wheel → energy recovery ventilator on roof; captures heat/coolth from exhaust air to pre-condition incoming outdoor air
- Insulated Mechanical Room → indoor mechanical room housing the ASHP; supplied with exhaust air to improve ASHP performance in cold weather
- ASHP → air-source heat pump located indoors, supplied with building exhaust air; primary heating source
- Refrigerant–Water HX → heat exchanger between refrigerant circuit and hydronic water loop
- Magnetic Chiller → high-efficiency chiller providing supplemental cooling
- Electric Boiler → backup/peak heating source for extreme cold conditions
- WSHP → water-source heat pump for supplemental heating/cooling
- Hydraulic Separator → decouples primary and secondary hydronic circuits
- Radiant Loop (×2) → hydronic radiant ceiling loops distributed to building spaces for heating and cooling]
...
Description:
A photograph showing the indoor air-source heat pumps (ASHPs) installed within the mechanical room at Montreal City Hall. The image shows multiple large ASHP units (resembling outdoor condensing units) installed inside an enclosed mechanical room, with ductwork connections visible overhead for supply of building exhaust air to the units.

Key Elements:
- Indoor ASHP units → Multiple large heat pump units installed inside the mechanical room rather than on the roof
- Ductwork connections → Overhead ductwork connecting the mechanical room to building exhaust air supply for the ASHPs
- Mechanical room enclosure → Insulated interior space that maintains warmer operating temperatures for the ASHPs compared to outdoor installation]
...
- **Occupant Comfort:** DOAS to completely ventilate an existing historic building to achieve ASHRAE Standard 62.1 and construction code requirements and use radiant heat wherever possible, together with CO2 sensors and RH sensors, to achieve ideal comfort conditions throughout building
...
[Table: Quebec GHG Emission Factors
Type: Table
...
Notes: Quebec GHG emission factors used in the Montreal City Hall carbon analysis. The extremely low electricity emission factor reflects Quebec's hydropower-dominated grid.]

[Figure: CS8.4 — GHG emissions comparison for project alternatives
Type: Chart

Description:
A stacked bar chart showing annual GHG emissions (Tons of CO2/yr) for three scenarios at Montreal City Hall: Existing Building, Initial Project, and Final Design. The bars are divided into two components: Electricity (blue) and Natural Gas (orange). The chart shows a dramatic reduction from the existing building to the final design, with a callout label "99% GHG Savings" highlighting the near-total elimination of natural gas combustion in the Final Design scenario.

Data Representation:
- Existing Building: approximately 1,050 Tons CO2/yr total (predominantly Natural Gas/orange portion ~1,000 Tons, small Electricity/blue portion ~50 Tons)
- Initial Project: approximately 600 Tons CO2/yr total (significant Natural Gas portion ~550 Tons, small Electricity portion ~50 Tons)
- Final Design: approximately 50–100 Tons CO2/yr total (minimal Natural Gas ~0, small Electricity portion ~50 Tons); "99% GHG Savings" callout shown

- Metric: Annual GHG Emissions (Tons of CO2/yr)
- Chart Type: Stacked Bar
- Units: Tons of CO2/yr

Chart Generation Hint:
- X-axis: Scenario names (Existing Building, Initial Project, Final Design)
- Y-axis: Tons of CO2/yr (0–2,500)
- Series: Electricity (blue), Natural Gas (orange)
- Key annotations: "99% GHG Savings" callout bubble; legend for Electricity and Natural Gas

Structured Data (Machine Readable):
{
  "chart_type": "bar",
  "metric": "Annual GHG emissions by scenario",
  "units": "Tons of CO2/yr",
  "data": {
    "Existing Building": {"Electricity": 50, "Natural Gas": 1000},
    "Initial Project": {"Electricity": 50, "Natural Gas": 550},
    "Final Design": {"Electricity": 50, "Natural Gas": 0}
  }
}]
...
Description:
An exterior photograph of the 47 Seventy apartment complex in Taylorsville, Utah. The image shows a two-story garden-style apartment building with beige/tan stucco and brick facade, exterior stairways, balconies, and mature trees surrounding the building. A parking area with cars is visible in the foreground.

Key Elements:
- Garden-style apartment buildings → Two-story residential buildings with exterior stairwells and balconies
- Landscaping → Mature trees surrounding the buildings
- Parking area → Surface parking in front of buildings
- Building address signage → "73-81" visible on building]

[Table: 47 Seventy Apartments Project Summary
Type: Table

Data:
| Field | Value |
|---|---|
| Project Name | 47 Seventy Apartments |
| Year Built | 1975 |
| Location | 4770 Simmental Dr., Taylorsville, UT |
| Building Size | 416 units in 20 buildings |
| Project Phase | Implemented, 2022 |
| Year Last Systems Upgrade | N/A |

Notes: Key project parameters for the 47 Seventy Apartments HVAC decarbonization retrofit.]
...
Description:
An exterior photograph of the McMullen County Courthouse in Tilden, Texas. The building is a two-story structure with a classical stone facade, prominent entry columns, symmetrical window arrangement, and a well-maintained lawn in the foreground. The building exhibits traditional courthouse architecture typical of early 20th century Texas public buildings.

Key Elements:
- Classical stone facade → Two-story courthouse with symmetrical, formal architectural style
- Entry columns → Prominent columns framing the main entrance
- Manicured lawn → Landscaped front yard with green grass
- Clear sky background → Rural Texas setting visible around the building]

[Table: McMullen County Courthouse Project Summary
Type: Table

Data:
| Field | Value |
|---|---|
| Project Name | McMullen County Courthouse |
| Year Built | 1930 |
| Location | Tilden, TX |
| Building Size | ~9000 ft² |
| Project Phase | Assessment |
| Year Last Systems Upgrade | N/A |

Notes: Key project parameters for the McMullen County Courthouse energy assessment.]
...
[Table: Ken Soble Tower Project Summary
Type: Table
...
| Year Built | 1967 |
| Location | Hamilton (Toronto), Canada |
| Building Size | 80,000 ft² (18 stories, 164 units) |
| Project Phase | Constructed 2020 |
| Year Last Systems Upgrade | N/A |

Notes: Key project parameters for the Ken Soble Tower passive house retrofit.]
...
| Existing | Retrofit |
|---|---|
| Hydronic baseboard heat served by central boiler plant | VRF heating/cooling with VAV boxes |
| Pressurized corridors, exhaust-only ventilation | DOAS ducted to each unit with central ERVs and tempered outdoor air |
| No cooling | Ceiling fans, shades, low SHGC windows |
| Central recirc gas boiler DHW | Condensing gas boiler plant for DHW |
...
[Figure: CS11.1 — Schematic view of existing tower conditions
Type: Descriptive Diagram

Description:
A schematic isometric cut-away diagram of the Ken Soble Tower (500 Macnab) showing the "BASE CONDITIONS" of the building before retrofit. The diagram uses numbered callouts to identify problems in three categories: Interiors, Systems, and Envelope. It is produced by ERA Architects for the Tower Renewal Partnership.

Key Elements:
- INTERIORS:
  - 1 Deteriorated fixture, millworks and appliances → aged interior finishes
  - 2 Deteriorated flooring → damaged floor surfaces
  - 3 Holes in fire separations between units → fire safety deficiencies
  - 4 Asbestos containing materials → hazardous materials present
  - 5 Mould remediation required in all interior walls → moisture and mold problems
  - 6 Pervasive pests → pest infestation
- SYSTEMS:
  - 7 Deteriorated central ductwork → aged HVAC distribution system
  - 8 Deteriorated plumbing → aged plumbing system
  - 9 Inadequate ventilation → insufficient fresh air supply
  - 10 Deteriorated electrical system → aged electrical infrastructure
- ENVELOPE:
  - 11 Deteriorated balcony slab edge → structural deterioration at balconies
  - 12 Deteriorated windows → aged, inefficient window assemblies
  - 13 Masonry repairs required → facade masonry in need of repair
  - 14 Deteriorated roof → aged roofing system

Image credit: ERA Architects]

[Figure: CS11.2 — Schematic diagram of retrofit measures
Type: Descriptive Diagram

Description:
A schematic isometric cut-away diagram of the Ken Soble Tower (500 Macnab) showing the "PASSIVE HOUSE RENEWAL" retrofit measures. The diagram uses numbered callouts organized into five categories: Life Safety, Comfort, Envelope, Systems, Units, Building Amenity, and State of Repair. It is produced by ERA Architects for the Tower Renewal Partnership.

Key Elements:
- LIFE SAFETY:
  - 1 Sprinklers → new fire suppression system
  - 2 New fire alarm system → upgraded life safety system
- COMFORT:
  - 3 Ceiling fans → passive cooling measure
  - 4 Central low energy cooling → central cooling system
- ENVELOPE:
  - ○ Triple glazed windows → high-performance window replacement
  - ○ Thermally continuous and airtight envelope with exterior and interior insulation → Passive House level envelope upgrade
- SYSTEMS:
  - ○ Direct ducting for fresh air supply in units with heat recovery → DOAS with ERVs
  - 4 Heat recovery → energy recovery from exhaust air
  - ○ New plumbing system → upgraded plumbing
  - ○ Modernized electrical system → upgraded electrical infrastructure
- UNITS:
  - ○ New kitchen → apartment interior upgrades
  - ○ New flooring → interior finishes renewal
  - ○ Repair of walls for continuous fire separations between units → fire safety upgrade
- BUILDING AMENITY:
  - 14 New community space at base and penthouse → amenity improvements
  - 15 New laundry facility → improved common area services
  - 16 Modernized landscape → exterior landscaping upgrade
- STATE OF REPAIR:
  - 17 All state of repair issues addressed to achieve 30 year plus asset renewal → comprehensive building renewal
...
Description:
An aerial photograph of the East Palo Alto Government Center building complex. The image shows a low-rise office building with a large flat roof, surrounded by surface parking lots, and carport structures visible in the parking area. The building address number 2415 is visible. Trees and suburban streetscape are visible around the perimeter.

Key Elements:
- Low-rise office building → Flat-roofed government office building visible from above
- Carport structures → Solar carport canopies in the parking lot (appear to have panels)
- Surface parking → Large surface parking surrounding the building
- Address marker → "2415" visible from aerial view]

[Table: East Palo Alto Government Center Project Summary
Type: Table

Data:
| Field | Value |
|---|---|
| Project Name | East Palo Alto Government Center |
| Year Built | 1973 |
| Location | East Palo Alto, CA |
| Building Size | 50,000 ft² |
| Project Phase | Designed in 2021 |
| Year Last Systems Upgrade | 1995 |

Notes: Key project parameters for the EPA Gov HVAC decarbonization retrofit.]
...
EPA Gov's HVAC systems were over 30 years old and had exceeded their expected service life. The HVAC system relied on pneumatic controls, offering limited strategies for control and no capacity to track system data. Space conditioning was accomplished via a central built-up air handling unit and variable air volume (VAV) reheat terminal units.
...
Description:
An aerial photograph of the Vera Cruz Village apartment complex in Richgrove, California. The image shows multiple one- and two-story residential garden-style apartment buildings arranged on a flat lot, with carport canopies visible in the parking areas. The carport structures appear to have solar PV panels installed on their roofs. The surrounding landscape is flat and agricultural.

Key Elements:
- Garden-style apartment buildings → Multiple one- and two-story residential buildings with typical California affordable housing construction
- Solar carports → Carport canopy structures with PV panels visible in the parking area
- Flat agricultural landscape → Rural Central California setting surrounding the complex]

[Table: Vera Cruz Village Project Summary
Type: Table

Data:
| Field | Value |
|---|---|
| Project Name | Vera Cruz Village |
| Year Built | 1995 |
| Location | Richgrove, CA |
| Building Size | 46,734 ft² (49 units) |
| Project Phase | Constructed 2022 |
| Year Last Systems Upgrade | N/A |

Notes: Key project parameters for the Vera Cruz Village affordable housing retrofit.]
...
Description:
A three-image collage showing envelope improvement work at Vera Cruz Village. The top image shows workers installing prefabricated insulated metal panels (IMPs) on a rooftop using a crane, with one worker guiding the panel into position. The bottom row shows a before-and-after comparison: the left image shows the existing buildings before retrofit with original asphalt roofing and older windows; the right image shows the same buildings after retrofit with the new metal panel roofing system and replaced windows.

Key Elements:
- Top image: IMP installation → Workers and crane installing prefabricated insulated metal panel on a residential rooftop during construction
- Before (bottom left) → Original one-story buildings with tan stucco exterior, aging asphalt shingle roofs, and original windows; older AC units visible at ground level
- After (bottom right) → Same buildings showing completed metal roof panel installation with updated windows and upgraded HVAC equipment]
...
[Figure: CS13.3 — Split system heat pump installation (Mechanical - Building 615)
Type: Image

Description:
A four-image collage showing the split system heat pump installation at Building 615 of Vera Cruz Village. Images show: outdoor condensing unit installation on a pad outside the building; wall-mounted indoor unit installation; ductwork routing in an attic or utility space; and close-up of the outdoor unit connection at the building wall.

Key Elements:
- Outdoor condensing unit → Split system ASHP outdoor unit installed on a ground-level concrete pad adjacent to the building
- Indoor air handler → Wall-mounted indoor unit installed inside the apartment
- Attic ductwork → Distribution ductwork routed through attic space
- Wall penetration → Refrigerant and electrical line penetration through exterior wall connecting indoor and outdoor units]

[Figure: CS13.4 — Ducted heat pump/ERV unit installation (Mechanical - Building 619)
Type: Image

Description:
A three-image collage showing the all-in-one ducted heat pump and ERV unit installation at Building 619 of Vera Cruz Village. Images show: the compact all-in-one unit installed in the ceiling/attic space; sheet metal ductwork connections to the unit; and the slim wall-mounted indoor PTHP unit installed in the living space.

Key Elements:
- All-in-one unit → Compact ceiling-installed all-in-one ducted heat pump and ERV unit (Ephoca brand) in the attic/ceiling space
- Sheet metal ductwork → Custom ductwork connecting the unit to distribution supply and return
- Through-wall PTHP → Slim through-wall packaged terminal heat pump unit installed in the living/kitchen space wall]
...
Description:
A side-by-side photograph showing a domestic hot water system upgrade at Vera Cruz Village. The left image (a — before) shows an existing gas water heater in an exterior closet with exposed flue pipe and conventional tank water heater. The right image (b — after) shows the same closet after retrofit with a heat pump water heater installed, which is larger and has a louvered door panel for airflow.

Key Elements:
- Before (a) → Conventional gas tank water heater in exterior closet; visible gas line and flue pipe
- After (b) → Heat pump water heater installed in the same exterior closet; louvered door panel installed for air supply to the heat pump; larger tank unit visible]
...
[Table: Skokie Courthouse Project Summary
Type: Table

Data:
| Field | Value |
|---|---|
| Project Name | Skokie Courthouse |
| Year Built | 1979 |
| Location | Cook County, Illinois |
| Building Size | 345,743 ft² |
| Project Phase | Implemented 2017 |
| Year Last Systems Upgrade | N/A |

Notes: Key project parameters for the Skokie Courthouse GSHP retrofit.]
...
Description:
A stacked area chart titled (implied) showing monthly electricity consumption (kWh) for the Skokie Courthouse broken down by end use category for the year 2013. The chart shows four stacked series: General (base load), Lighting, Fans, and Central Plant. The chart shows seasonal variation with higher Central Plant consumption in summer (cooling) and higher overall consumption in winter months.

Data Representation:
- General (blue/gray area): baseline electricity consumption present all year, approximately 200,000–400,000 kWh/month
- Lighting (blue hatched area): consistent year-round consumption
- Fans (orange hatched area): moderate year-round consumption
- Central Plant (orange solid area): highest in summer months (~400,000+ kWh), representing cooling loads; also elevated in winter for heating

- Metric: Monthly electricity consumption (kWh) by end use
- Chart Type: Stacked Area
- Units: kWh

Chart Generation Hint:
- X-axis: Month (January through December)
- Y-axis: kWh (0–1,200,000)
- Series: General, Lighting, Fans, Central Plant (stacked)
- Key annotations: Legend identifying four series

Structured Data (Machine Readable):
{
  "chart_type": "bar",
  "metric": "Monthly electricity consumption by end use",
  "units": "kWh",
  "data": {
    "series": ["General", "Lighting", "Fans", "Central Plant"],
    "note": "Monthly values approximate; peak total ~1,000,000 kWh in summer; Central Plant dominates summer months"
  }
}]
...
Description:
An exterior photograph of the Stella B. Werner Council Office Building in Montgomery County, Maryland. The building is a multi-story government office building with a modernist architectural style featuring a mix of glass curtain wall and concrete facade elements. Trees are visible in the foreground, and a street sign is partially visible at lower right.

Key Elements:
- Multi-story office building → Government office building with modernist design including concrete and glass facade elements
- Building signage → "Stella B.R... Building" sign visible on the facade
- Street-level landscaping → Trees and plantings at the base of the building]

[Table: Stella B. Werner Council Office Building Project Summary
Type: Table

Data:
| Field | Value |
|---|---|
| Project Name | Stella B. Werner Council Office Building |
| Year Built | 1952 (Central Core); 1962 (South Wing); 1970s–1980s (further additions) |
| Location | Montgomery County, Maryland |
| Building Size | 142,480 ft² |
| Project Phase | Implemented 2021 |
| Year Last Systems Upgrade | Variable |

Notes: Key project parameters for the Stella B. Werner COB VRF retrofit.]
...
Description:
A floor plan/site diagram of the Stella B. Werner Council Office Building complex showing the layout and names of the different wings and areas. The diagram uses color-coded sections to identify each building wing.

Key Elements:
- Health Wing → labeled wing on the left side of the complex
- Parking Garage → large area on the upper right of the complex
- Auditorium → centrally located area connecting the Health Wing to the Core
- Connector → corridor/link element between building sections
- Council Wing → wing on the lower left of the complex
- Core & Core South → central main building mass
- South Wing → wing extending to the right of the core]
...
### Providence Elementary School (Phase 1)

[Table: Providence Elementary School Project Summary
Type: Table
...
Notes: Key project parameters for the Providence Elementary GSHP retrofit.]
...
### Strawbridge Elementary School (Phases 5 and 6)

[Table: Strawbridge Elementary School Project Summary
Type: Table
...
Notes: Key project parameters for the Strawbridge Elementary GSHP retrofit.]
...
[Table: Centerville Elementary School Project Summary
Type: Table
...
Notes: Key project parameters for the Centerville Elementary GSHP retrofit.]
...
| Existing | Retrofit |
|---|---|
| Classroom two-pipe WSHPs; DX RTUs and outdoor air units; Heating: 510 kW electric boiler; Cooling: closed circuit cooling tower | GS well field: 220 wells, 300 ft deep; Heat pump RTUs and outdoor air units |
...
Description:
An exterior photograph of the STAR Transit facility in Terrell, Texas. The building is a single-story metal industrial/commercial building with a metal roof, red-and-tan striped trim, and a flagpole in the front. The surrounding area is flat with a paved parking lot and open sky.

Key Elements:
- Metal building → Single-story industrial/commercial building with metal wall panels and roof
- Red accent trim → Decorative red stripes on the upper facade
- Flagpole → Flagpole visible near the building entrance
- Flat open setting → Flat commercial/industrial site typical of small Texas town]
...
Analysis showed that there will be only three hours of overlap between PV generation and bus charging with no energy storage available. The figures below show the comparison between PV generation vs. EV charging for representative days for the months of January, April, June, and October. STAR Transit moved forward with PV system installation to avoid expiration of funds, and the next recommended step for their fleet decarbonization is installation of battery storage to fully harness the clean PV energy generation to charge the bus fleet overnight.

[Figure: CS17.2 — Solar generation vs. EV Charging for (a) January, (b) April, (c) July, and (d) October
Type: Chart

Description:
A four-panel line chart showing the comparison between hourly solar PV generation (kWh) and hourly EV bus charging demand (kWh) for four representative months at STAR Transit: (a) January, (b) April, (c) July, and (d) October. In each panel, the Solar Generation line forms a daytime bell curve peaking around noon, while the EV Bus Charge line shows demand concentrated in the evening/overnight hours (after 6:00 PM). The overlap between the two curves is minimal (approximately 3 hours per day), illustrating the mismatch between solar generation timing and EV charging demand.

Data Representation:
- Solar Generation vs. EV Charging — January: Solar peak ~80 kWh at midday; EV charge curve ~60–80 kWh in evening; minimal overlap
- Solar Generation vs. EV Charging — April: Solar peak ~200–220 kWh at midday; EV charge curve ~80–100 kWh in evening; minimal overlap
- Solar Generation vs. EV Charging — July: Solar peak ~200–220 kWh at midday; EV charge curve ~100 kWh in evening; minimal overlap
- Solar Generation vs. EV Charging — October: Solar peak ~160–180 kWh at midday; EV charge curve ~100 kWh in evening; minimal overlap

- Metric: Hourly solar generation and EV bus charging demand (kWh)
- Chart Type: Line (4-panel)
- Units: kWh

Chart Generation Hint:
- X-axis per panel: Hour of day (12:00 AM to 11:00 PM)
- Y-axis per panel: kWh (range varies by month: January 0–100, April/July 0–250, October 0–200)
- Series per panel: Solar Generation (kWh) [bell curve], EV Bus Charge (kWh) [evening step/curve]
- Key annotations: Panel labels (a), (b), (c), (d) for each month; legend entries "Solar Generation (KWh)" and "EV Bus Charge (KWh)"

Structured Data (Machine Readable):
{
  "chart_type": "line",
  "metric": "Solar generation vs. EV charging by hour",
  "units": "kWh",
  "data": {
    "panels": ["January", "April", "July", "October"],
    "series": ["Solar Generation (kWh)", "EV Bus Charge (kWh)"],
    "key_finding": "Only ~3 hours of overlap between daytime solar generation and evening EV charging with no storage",
    "note": "Individual hourly values approximate from chart"
  }
}]
...
[Figure: CS18.1 — Schematic Diagram of North Oak Ambient District Loop
Type: Descriptive Diagram

Description:
A schematic diagram showing the North Oak ambient district energy system layout for five residential towers (Tower A through Tower E) connected through a shared geothermal/ambient distribution network. The diagram uses labeled lines and symbols to show the flow of heat pump piping, DHW distribution, geo exchange/ambient distribution, heating distribution, and flue connections. Each tower connects to the district system via an Energy Transfer Station (ETS) with two heat exchangers.

Key Elements:
- Tower A through Tower E → Five residential towers connected to the district system
- ETS (Energy Transfer Station) → Equipment at each building providing the interface between the district loop and the in-building systems; two ETS per building group shown
- Heat Pump Piping (solid line) → Connects building WSHPs to the ambient/geothermal district loop
- Geo Exchange / Ambient Distribution (dashed line) → Distribution network for ambient temperature water (34°F–90°F) from geothermal fields
- DHW (dot-dash line) → Domestic hot water distribution from central boiler at 145°F
- Heating Plant (solid square symbol) → Central natural gas boiler providing DHW and backup heating
- Heating Distribution (solid line) → Hot water distribution from heating plant
- Flue (arrow) → Exhaust from the central heating plant

Image credit: Creative Energy (2022)]
...
Description:
An exterior photograph of Kitsilano Pool in Vancouver, British Columbia. The image shows the outdoor pool facility with the pool in the foreground filled with blue water. Mountains of North Vancouver are visible in the background across the water. Palm trees and other vegetation are visible along the pool deck. The facility building is visible at the far end of the pool.

Key Elements:
- Outdoor swimming pool → Large outdoor pool filled with blue water
- Mountain backdrop → North Vancouver mountains visible across Burrard Inlet in the background
- Pool deck and landscaping → Palm trees and tropical plantings along the pool edge
- Pool facility building → Service and changing room building at far end of pool]

[Table: Kitsilano Pool Project Summary
Type: Table
...
Notes: Key project parameters for the Kitsilano Pool domestic hot-water heat pump retrofit.]
...
| Existing | Retrofit |
|---|---|
| Mid-efficiency 725 MBH atmospheric domestic hot-water boiler with two 120-gallon unfired hot-water tanks | 210 MBH CO2 air-source heat pump water heater with 500 gallons of DHW storage and an electric resistance swing tank |
...
[Figure: CS19.2 — Schematic diagram of Kitsilano Pool domestic hot-water system
Type: Descriptive Diagram

Description:
A building automation system (BAS) graphical interface screenshot showing the schematic of the Kitsilano Pool domestic hot-water system. The interface is from WEBIR Automation & Control Services and is labeled "Domestic Hot Water System — Kitsilano Pool." The diagram shows the interconnection of the CO2 air-source heat pump (ASHP-1), primary storage tanks (DHWT-1 and DHWT-2), electric swing tank, and associated piping with live temperature readings, status indicators, and control values.

Key Elements:
- ASHP-1 → Air-source CO2 heat pump unit shown on the left with live operating temperatures (~26.4°C supply, ~25.6°C return) and status (Disabled/Enabled, Status, Comp Status, Alarm indicators)
- Lync Dual Loop Package → Heat pump refrigerant-to-water heat exchanger component at ~33.3°C
- DWP-2 → Intermediate pump/loop component at ~0.04 Amp
- DHWT-1 → First primary 250-gallon DHW storage tank with temperature readings (~24.7°C, ~23.1°C, ~27.0°C, ~23.6°C)
- DHWT-2 → Second primary 250-gallon DHW storage tank with temperature readings (~25.0°C, ~24.9°C, ~19.5°C)
- Storage Tank PV1 (950L) → Primary hot water storage tank with 54 kW electric element; status Disabled
- Electric Tank PV1 (950L) → Swing tank with 18 kW electric element; Enable/Status shown at 0.06 Amp
- DWP-1 → Distribution pump with 0.0% status and −0.03 Amp
- DCW → Domestic cold water inlet
- DHWR → Domestic hot water return
- DHWS → Domestic hot water supply
- OA TEMPERATURE → Outdoor air temperature sensor showing 8.6°C
- Mech Rm Fan Status → Mechanical room fan showing Off status

Image credit: First Light Energy Solutions]
