...
**[Figure: GRI Standards]**

Type: map

Geographic Scope: None

Description: The image presents a flowchart illustrating the application of GRI Standards, which are guidelines for reporting on sustainability performance. The chart is divided into three main sections: Universal Standards, Sector Standards, and Topic Standards.

Legend Items:

*   Green boxes represent Universal Standards.
*   Brown boxes represent Sector Standards.
*   Purple boxes represent Topic Standards.

Key Locations:

*   Universal Standards: These are the foundational principles that apply to all organizations, regardless of their sector or industry.
*   Sector Standards: These are specific guidelines tailored to different sectors, such as energy, finance, or healthcare.
*   Topic Standards: These are detailed disclosures related to specific topics, such as climate change, human rights, or supply chain management.

The flowchart shows how these standards can be applied in a hierarchical manner, with Universal Standards serving as the foundation, followed by Sector Standards, and finally, Topic Standards. This visual representation helps organizations understand how to use the GRI Standards effectively in their sustainability reporting.
...
Description: The image presents a flowchart illustrating the GRI Standards, which are divided into three main categories: Universal Standards, Sector Standards, and Topic Standards. The flowchart provides guidance on how to apply these standards in reporting.

Legend Items:

*   Green boxes -> Universal Standards
*   Brown boxes -> Sector Standards
*   Purple boxes -> Topic Standards

Key Locations:

*   Universal Standards: This section includes three standards that apply to all organizations, regardless of their sector or industry.
*   Sector Standards: This section provides sector-specific standards that apply to organizations within a particular sector.
*   Topic Standards: This section includes topic-specific standards that provide guidance on reporting specific information related to material topics.

The flowchart suggests that organizations should first apply the Universal Standards, then select the relevant Sector Standards based on their industry, and finally choose the appropriate Topic Standards to report on specific material topics.
...
Description: The table displays information related to filing, including the filing information, legal entity identifier, GRI company identifier number, level of accordance, and sectors standards used.
...
*   Filing Information -> This section provides details about the filing process.
*   Legal Entity Identifier -> This field contains a unique identifier for the legal entity.
*   GRI Company Identifier Number -> This field contains a unique identifier for the company according to the Global Reporting Initiative (GRI) standards.
*   Level of accordance -> This field indicates the level of compliance with the reporting standards.
*   Sectors Standards used -> This field lists the specific sectors and standards used in the reporting process.
...
Description: The table displays a hierarchical structure of elements, with the root level at the top and subsequent levels branching out below it. The table is divided into two columns, with the left column listing the element names and the right column providing additional information about each element.

Legend Items:

*   **Root Level**: The topmost level in the hierarchy, representing the overall structure.
*   **Hypercube [Table]**: A table that contains data related to the root level.
*   **Axis [Axis]**: A dimension or category that defines the scope of the data.
*   **Domain [Domain]**: The specific area or range of values associated with the axis.
*   **Member [Member]**: An individual item or value within the domain.
*   **Primary Elements [line items]**: The main components or features of the data.
*   **Primary Element 1**: A specific primary element, such as a product or service.
*   **Primary Element 2**: Another primary element, possibly related to the first one.
*   **Primary Element 3**: A third primary element, which may be distinct from the previous two.

Key Locations:

*   **Root Level**: The starting point for understanding the hierarchical structure.
*   **Hypercube [Table]**: Provides context for the data and its relationships.
*   **Axis [Axis]**: Defines the scope and boundaries of the data.
*   **Domain [Domain]**: Specifies the range of values or categories within the axis.
*   **Member [Member]**: Represents an individual item or value within the domain.
*   **Primary Elements [line items]**: Highlights the main components or features of the data.
*   **Primary Element 1**: Focuses on a specific primary element, such as a product or service.
*   **Primary Element 2**: Emphasizes another primary element, possibly related to the first one.
*   **Primary Element 3**: Draws attention to a third primary element, which may be distinct from the previous two.
...
Type: Not a map, but a text-based figure.

Geographic Scope: N/A

Description: The figure presents a text-based description of the reporting organization's requirements for disclosing materials used by weight or volume. It outlines the information that must be reported, including the total weight or volume of materials used to produce and package the organization's primary products and services during the reporting period.
...
Description: The table presents a list of materials used by weight or volume, categorized into different types such as non-renewable and renewable materials. The table also includes columns for disclosure of materials and explicit dimension.

Legend Items:

*   **Material Resource [axis]**: This axis represents the different types of materials used, including non-renewable and renewable materials.
*   **Material Resource [domain]**: This domain refers to the specific category of materials being reported, such as non-renewable or renewable materials.
*   **Non-renewable material**: This type of material is not replenished naturally and is typically extracted from the earth.
*   **Renewable material**: This type of material can be replenished naturally and is often sourced from living organisms.

Key Locations:

*   **Disclosure of Materials [abstract]**: This section provides an overview of the materials used by the organization.
*   **Materials Used by Weight or Volume [table]**: This table presents the detailed data on the materials used by the organization, including the weight or volume of each material.
*   **301-1-a: Total weight of materials that are used to produce and package the organization's primary products and services**: This metric measures the total weight of materials used in the production and packaging of the organization's primary products and services.
*   **301-1-a: Total volume of materials that are used to produce and package the organization's primary products and services**: This metric measures the total volume of materials used in the production and packaging of the organization's primary products and services.
...
Type: Not a map, but a text-based disclosure statement.

Geographic Scope: N/A

Description: The image presents a disclosure statement titled "Disclosure 401-1 New employee hires and employee turnover." It outlines the requirements for reporting new employee hires and employee turnover during a specific period, categorized by age group, gender, and region. The statement is divided into two sections: "a" for total number and rate of new employee hires, and "b" for total number and rate of employee turnover.
...
Description: The table displays the disclosure of employees broken down by region. It includes columns for the region, typed dimension, and various employee categories such as total number of employees, permanent employees, temporary employees, non-guaranteed hours employees, full-time employees, and part-time employees.
...
Type: Not a map, but a table

Geographic Scope: N/A

Description: The table outlines the requirements for disclosure of entities included in an organization's sustainability reporting. It consists of three levels, each with specific requirements for listing entities, explaining approaches to consolidating information, and taking into account mergers, acquisitions, and disposal of entities or parts of entities.

Legend Items:

* Level 1: List all entities included in sustainability reporting
* Level 2: If the organization has audited consolidated financial statements or financial information filed on public record, specify the differences between the list of entities included in its financial reporting and the list included in its sustainability reporting
* Level 3: If the organization consists of multiple entities, explain the approach used for consolidating the information, including whether the approach involves adjustments to information for minority interests, how the approach takes into account mergers, acquisitions, and disposal of entities or parts of entities, and whether and how the approach differs across the disclosures in this Standard and across material topics
...
Type: Not a map, but rather a table of contents for a sustainability report.

Geographic Scope: N/A

Description: The image displays a table of contents for a sustainability report, with various sections and subsections related to disclosure and reporting. The table of contents is organized in a hierarchical structure, with main sections and subheadings that provide an overview of the report's content.
...
Description: The table presents a list of material topics, including likely material topics for various sectors such as Oil and Gas, Coal, Agriculture, Aquaculture and Fishing, and Mining. It also includes lists of applicable disclosures for each sector.

Legend Items:

*   **E** -> List of likely material topics
*   **E** -> List of applicable disclosures

Key Locations:

*   **Oil and Gas Sector**: Includes likely material topics such as environmental impact, health and safety, and supply chain management.
*   **Coal Sector**: Includes likely material topics such as environmental impact, health and safety, and community engagement.
*   **Agriculture, Aquaculture and Fishing Sectors**: Includes likely material topics such as environmental impact, health and safety, and supply chain management.
*   **Mining Sector**: Includes likely material topics such as environmental impact, health and safety, and community engagement.
...
Description: The table presents a list of topics in sector standards that are determined as not material. The topics are organized by sector, including oil and gas, coal, agriculture, aquaculture and fishing, mining, and applicable sector standards.

Legend Items:

*   **+**: Indicates a topic that is applicable to the sector.
*   **-**: Indicates a topic that is not applicable to the sector.

Key Locations:

*   **Oil and Gas Sector**: Topics in this sector include disclosure of topics applicable for sector standards determined as not material, topics in applicable sector standards determined as not material, and topics in oil and gas sector determined as not material.
*   **Coal Sector**: Topics in this sector include topics in coal sector determined as not material.
*   **Agriculture, Aquaculture and Fishing Sectors**: Topics in these sectors include topics in agriculture, aquaculture and fishing sectors determined as not material.
*   **Mining Sector**: Topics in this sector include topics in mining sector determined as not material.
*   **Applicable Sector Standards**: Topics in this category include topics in applicable sector standards determined as not material and explanation of why the topic applicable for sector standards is determined as not material.
...
Description: This figure presents a list of requirements for entities included in an organization's sustainability reporting. The list includes three main points, each with subpoints that provide further clarification on what information should be disclosed.
...
Description: The table provides a list of entities included in the organization's sustainability reporting, along with their corresponding explanations and references to specific sections of the report.

Legend Items:

*   2-2-a: List of all entities included in the sustainability reporting
*   2-2-b: Differences between the list of entities included in financial reporting and the list included in sustainability reporting
*   2-2-c: Explanation of the approach used for consolidating the information across multiple entities
*   2-2-c-i: The approach used for consolidating the information involves adjustments to information
*   2-2-c-ii: Explanation of how the approach takes into account mergers, acquisitions, and disposal
*   2-2-c-iii: The approach used for consolidating the information is different across the disclosures
