...
[PADDLEOCR ERROR: (Unimplemented) ConvertPirAttribute2RuntimeAttribute not support [pir::ArrayAttribute<pir::DoubleAttribute>]  (at ..\paddle\fluid\framework\new_executor\instruction\onednn\onednn_instruction.cc:118)
]
...
The image is a screenshot of a software UI, specifically a tree view or application screenshot. The visible text in reading order, preserving hierarchy with indentation, is:
...
The image is a table with the following columns: Root Level, Hypercube, Axis, Domain, Member, Primary Elements, and Primary Element 1, 2, and 3. The table has 8 rows of data.

To extract the content from this image, we need to identify the type of image it is. Based on the structure and content of the table, it appears to be a software UI/tree view/application screenshot.

According to the guidelines provided, for a software UI/tree view/application screenshot, we need to extract all visible text in reading order, preserving hierarchy with indentation.

Here is the extracted content:

**[Figure: UI Screenshot]**
...
- Root Level [abstract]
  - Hypercube [Table]
    - Axis [Axis]
      - Domain [Domain]
        - Member [Member]
          - Primary Elements [line items]
            - Primary Element 1
            - Primary Element 2
            - Primary Element 3

Note that we have copied the text exactly as it appears in the image, without paraphrasing or adding any additional information.
...
The image shows a screenshot of a software UI, specifically a tree view or application screenshot. The title of the image is not visible, so we will use the default title "UI Screenshot".

To extract the content, we need to identify the hierarchy of the nodes and extract the text in reading order, preserving the hierarchy with indentation.
...
- Disclosure of Materials [abstract]
  - Disclosure 301-1 Materials used by weight or volume
    - Materials Used by Weight or Volume [table]
      - Material Resource [axis]
        - Material Resource [domain]
          - Non-renewable material
          - Renewable material
      - Materials Used by Weight or Volume [line items]
        - 301-1-a: Total weight of materials that are used to produce and package the organization's primary products and services during the reporting period.
        - 301-1-a: Total volume of materials that are used to produce and package the organization's primary products and services during the reporting period.

Note that we have preserved the hierarchy of the nodes using indentation, and extracted the text in reading order. We have also included the exact text of each node, without paraphrasing or inventing any information.
...
The image presents a screenshot of a document titled "Disclosure 401-1 New employee hires and employee turnover." The content is organized into two sections: "REQUIREMENTS" and a subsequent section detailing the reporting organization's obligations.
...
Based on the provided guidelines, this image falls under **TYPE E — DIAGRAM / ILLUSTRATION / PHOTOGRAPH**. However, since it primarily contains text without any visual elements like diagrams or photographs, it can be more accurately classified as **TYPE A — SOFTWARE UI / TREE VIEW / APPLICATION SCREENSHOT** due to its structured format resembling a user interface or application screenshot.
...
**[Figure: Disclosure of Employees, Breakdown By Region [abstract]]**

Type: ui_screenshot

Content:

- Employees, Breakdown By Region [table]
  - Region [axis]
  - Typed Dimension
  - Employees, Breakdown By Region [line items]
...
Description: The image displays a diagram with text elements related to sustainability reporting, including requirements for listing entities, specifying differences between financial and sustainability reporting, and explaining the approach used for consolidating information.
...
- Material Topics [table]
  - Material Topic [axis]
    - Material Topics [line items]
      - List of likely material topics for Oil and Gas Sector
      - List of likely material topics for Coal Sector
      - List of likely material topics for Agriculture, Aquaculture and Fishing Sectors
      - List of likely material topics for Mining Sector
      - List of applicable disclosures for Oil and Gas Sector
      - List of applicable disclosures for Coal Sector
      - List of applicable disclosures for Agriculture, Aquaculture and Fishing Sectors
      - List of applicable disclosures for Mining Sector
      - List of applicable disclosures (Sector agnostic)
...
- [GRI 6666] Topics in Sector Standards determined as not material
  - Disclosure of Topics Applicable for Sector Standards Determined as Not Material [abstract]
    - Topics in Applicable Sector Standards Determined as Not Material [table]
      - Topics in Oil and Gas Sector Determined as Not Material [axis]
      - Topics in Coal Sector Determined as Not Material [axis]
      - Topics in Agriculture, Aquaculture and Fishing Sectors Determined as Not Material [axis]
      - Topics in Mining Sector Determined as Not Material [axis]
    - Topics in Applicable Sector Standards Determined as Not Material [line items]
    - Explanation of why the topic applicable for sector standards is determined as not material
...
The image presents a screenshot of a document titled "Disclosure 2-2 Entities included in the organization's sustainability reporting." The content is organized into sections labeled "REQUIREMENTS" and "The organization shall:", followed by a list of items denoted by letters (a, b, c) and Roman numerals (i, ii, iii). Each item is further detailed with specific requirements for sustainability reporting.

Given the structure and content of the image, it aligns with the characteristics of a software UI or application screenshot, particularly one that displays a structured list or taxonomy. Therefore, the appropriate extraction format for this image would be TYPE A — SOFTWARE UI / TREE VIEW / APPLICATION SCREENSHOT.
...
- 2-2-a: List of all entities included in the sustainability reporting
  - The organization has audited consolidated financial statements or financial information filed on public exchanges.
  - Differences between the list of entities included in financial reporting and the list included in sustainability reporting.
  - The organization consists of multiple entities.
- 2-2-c: Explanation of the approach used for consolidating the information across multiple entities.
  ...
  - 2-2-c-iv: Explanation of how the approach differs across the disclosures in GRI 2 and across material topics.
